...
"""
InlineReconstruction shows how to use rtk::FDKConeBeamReconstructionFilter to
reconstruct inline / on-the-fly with RTK's implementation of FDK
(DOI: 10.1364/JOSAA.1.000612) during the acquistion of the projections.
"""
