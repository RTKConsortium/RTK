...
protected:
  ThreeDCircularProjectionGeometryXMLFileReader():  m_Geometry(GeometryType::New()) {this->m_OutputObject = &(*m_Geometry);};
...
private:
  ThreeDCircularProjectionGeometryXMLFileReader(const Self&); //purposely not implemented
...
private:
  ThreeDCircularProjectionGeometryXMLFileWriter(const Self&); //purposely not implemented
  void operator=(const Self&); //purposely not implemented
