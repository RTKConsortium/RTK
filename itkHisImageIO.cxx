...
// Includes
#include <fstream>
#include "itkHisImageIO.h"

//--------------------------------------------------------------------
// Read Image Information
void itk::HisImageIO::ReadImageInformation()
{
  // open file
...
//--------------------------------------------------------------------
// Read Image Content
void itk::HisImageIO::Read(void * buffer)
{
  // open file
  std::ifstream file(m_FileName.c_str(), std::ios::in | std::ios::binary);
  if ( file.fail() )
...
//--------------------------------------------------------------------
bool itk::HisImageIO::CanWriteFile(const char* FileNameToWrite)
{
