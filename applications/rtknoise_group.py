...
def SetNoiseFromArgParse(projections, args_info):
    ...
    if args_info.gaussian is not None:
        ...
        image = noisy.GetOutput()

    if args_info.poisson is not None:
        I0, muref = args_info.poisson

        multiply = itk.MultiplyImageFilter[OutputImageType, OutputImageType].New()
        ...
        multiply2 = itk.MultiplyImageFilter[OutputImageType, OutputImageType].New()
        ...
        multiply3 = itk.MultiplyImageFilter[OutputImageType, OutputImageType].New()
        ...
        multiply4 = itk.MultiplyImageFilter[OutputImageType, OutputImageType].New()
