...
def build_parser():
    ...
    parser.add_argument("--range", nargs=3, type=int, help="Range of projection to analyse min step max", metavar=("MIN","STEP","MAX"))

    parser.add_argument("--lambda", "-l", dest="lambda_", type=float, default=0.8, help="RLS estimate coefficient")
    parser.add_argument("--expected", "-e", dest="expected", type=int, default=65535, help="Expected I0 value")
