...
#include "rtkvectorbackprojections_ggo.h"
...
{
  GGO(rtkvectorbackprojections, args_info);
  ...
  typedef itk::VectorImage< OutputPixelType, Dimension - 1 > ProjectionImageType;
#endif
  // Geometry
  ...
  rtk::SetConstantImageSourceFromGgo<ConstantImageSourceType, args_info_rtkvectorbackprojections>(constantImageSource, args_info);
...
//      break;
//    case(bp_arg_Joseph):
      bp = rtk::JosephBackProjectionImageFilter<OutputImageType,
                                                OutputImageType,
