...
def process(args_info: argparse.Namespace):
    ...
    IWM = rtk.InterpolationWeightMultiplicationBackProjection[
        OutputPixelType, OutputPixelType
    ]
    SSM = rtk.StoreSparseMatrixSplatWeightMultiplication[
    ...
    backProjection.GetSplatWeightMultiplication().Resize(
        ...
        constant_image_source.GetOutput()
    ...
    backProjection.GetSplatWeightMultiplication().SetVolumeBuffer(
        constant_image_source.GetOutput().GetBufferPointer()
    )
    ...
    matlab_matrix.SetMatrixFromFunctor(backProjection.GetSplatWeightMultiplication())
    matlab_matrix.SetOutput(backProjection.GetOutput())
