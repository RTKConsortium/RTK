# Motion-compensated ROOSTER : regularized 3D + time reconstruction with known motion
...
RTK provides several tools to reconstruct a 3D + time image using explicit motion estimation. Motion-compensated ROOSTER is one of them.
