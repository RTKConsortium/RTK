...
int main(int argc, char * argv[])
{
  ...
  if (args_info.time_given)
    {
    if (!strcmp(args_info.time_arg, "compact"))
      {
      rtk::GlobalTimer::GetInstance()->SetVerbose(false);
      rtk::GlobalTimer::GetInstance()->Report();
      }
    if (!strcmp(args_info.time_arg, "detailed"))
      {
      rtk::GlobalTimer::GetInstance()->SetVerbose(true);
      rtk::GlobalTimer::GetInstance()->Report();
      }
    } 
