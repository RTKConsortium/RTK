...
def build_parser():
    parser = rtk.RTKArgumentParser(description="Masks out the collimator from the projections")
    ...
    parser.add_argument("--output", "-o", required=True, help="Output projections file name")
