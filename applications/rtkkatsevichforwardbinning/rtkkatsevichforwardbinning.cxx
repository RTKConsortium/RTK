...
#include "rtkkatsevichforwardbinning_ggo.h"
...
{
  GGO(rtkkatsevichforwardbinning, args_info);
  ...
  rtk::SetProjectionsReaderFromGgo<ReaderType, args_info_rtkkatsevichforwardbinning>(reader, args_info);
  ...
  using KatsevichForwardBinningType = rtk::KatsevichForwardBinningImageFilter<OutputImageType, OutputImageType>;
  KatsevichForwardBinningType::Pointer fwd = KatsevichForwardBinningType::New();
