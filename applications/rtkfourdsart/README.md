# 4D SART : unregularized 3D + time reconstruction
...
The 4D SART algorithm requires that we associate each projection image with the instant of the respiratory cycle at which it has been acquired.
