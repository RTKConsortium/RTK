#ifndef __itkRayQuadricIntersectionFunction_h
#define __itkRayQuadricIntersectionFunction_h
...
public:
  ...
  typedef typename ImageBase<VDimension>::ConstPointer          ImageBaseConstPointer;
  ...
  /** Useful defines. */
  typedef Vector<TCoordRep, VDimension> VectorType;
...
#include "itkRayQuadricIntersectionFunction.txx"
#endif
