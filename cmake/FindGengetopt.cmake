...
if(NOT TARGET gengetopt)
  ...
  if((GENGETOPT STREQUAL "GENGETOPT-NOTFOUND") OR (GENGETOPT STREQUAL ""))
    ...
    add_subdirectory(
      ${CLITK_CMAKE_DIR}/../utilities/gengetopt
    ...
    if(EXISTS ${GENGETOPT})
      ...
      message(
        FATAL_ERROR
        "No gengetopt executable found at the specified location"
      )
    endif()
  endif()
endif()
...
macro(WRAP_GGO GGO_SRCS)
  ...
  add_custom_command(
    OUTPUT
      "${CMAKE_CURRENT_BINARY_DIR}/${FIRST_GGO_BASEFILENAME}"
    COMMAND
      ${CMAKE_COMMAND} -D INPUTS="${GGO_FILES_ABS_LIST}" -D
  ...
  set(
    GGO_OUTPUT
    ${CMAKE_CURRENT_BINARY_DIR}/${GGO_H}
  ...
  add_custom_command(
    ...
    COMMAND
      gengetopt
    ARGS
      --input=${CMAKE_CURRENT_BINARY_DIR}/${FIRST_GGO_BASEFILENAME}
      --output-dir=${CMAKE_CURRENT_BINARY_DIR}
      --arg-struct-name=args_info_${GGO_BASEFILENAME}
      --func-name=cmdline_parser_${GGO_BASEFILENAME}
      --file-name=${GGO_BASEFILENAME}_ggo --unamed-opts --conf-parser
      --include-getopt --set-package ${CMAKE_PROJECT_NAME}
    DEPENDS
      ${CMAKE_CURRENT_BINARY_DIR}/${FIRST_GGO_BASEFILENAME}
  )
  set(
