/*
  ...
  /usr/bin/gengetopt --output-dir=/home/srit/src/rtk/RTK --arg-struct-name=args_info_rtkramp --func-name=cmdline_parser_rtkramp --file-name=rtkramp_ggo --unamed-opts --conf-parser --include-getopt 
