...
int main(int argc, char* argv[])
{
  ...
  feldkamp->GetRampFilter()->SetHannCutFrequency(0.05);
  ...
  // Error per Pixel
  ErrorType ErrorPerPixel = TestError/pixelCounter;//TestError/(size[0]*size[1]*size[2]);
  std::cout << "\nError per Pixel = " << ErrorPerPixel << std::endl;
  // MSE
  ErrorType MSE = EnerError/pixelCounter;//(size[0]*size[1]*size[2]);
