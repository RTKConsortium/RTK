...
int main(int argc, char* argv[])
{
  ...
  ConstantImageSourceType::PointType tomographyOrigin;
  ConstantImageSourceType::PointType projectionsOrigin;
  //origin.Fill(-179.5);
  tomographyOrigin[0] = -179.5;
  tomographyOrigin[1] = -179.5;
  tomographyOrigin[2] = -179.5;
  projectionsOrigin[0] = -179.5;
  projectionsOrigin[1] = -179.5;
  projectionsOrigin[2] = -179.5;
  ConstantImageSourceType::SizeType size;
  size.Fill(360);
  ConstantImageSourceType::SpacingType spacing;
  spacing.Fill(1.);
  tomographySource->SetOrigin( tomographyOrigin );
  tomographySource->SetSpacing( spacing );
  tomographySource->SetSize( size );
  tomographySource->SetConstant( 0. );
  tomographySource->UpdateOutputInformation();
  size[2]=360;
  projectionsSource->SetOrigin( projectionsOrigin );
  ...
  slp->SetPhantomOriginOffsetX(100.);
  slp->Update();
  ...
  feldkamp->GetRampFilter()->SetTruncationCorrection(0.25);
  ...
  dsl->SetPhantomOriginOffsetX(100.);
