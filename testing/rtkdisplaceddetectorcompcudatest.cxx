...
int main(int, char** )
{
  ...
  geometry->AddProjection(600., 0., 0, 84., 35, 23, 15, 21, 26);
  geometry->AddProjection(500., 45., 0, 21., 12, 16, 546, 14, 41);
  geometry->AddProjection(700., 90., 0, 68., 68, 54, 38, 35, 56);
  geometry->AddProjection(900., 135., 0, 48., 35, 84, 10, 84, 59);
