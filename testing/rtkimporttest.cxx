...
#else
void CheckError(typename TImage::Pointer recon,
  ...
  while( !itTest.IsAtEnd() )
    {
      ...
      TestError += vcl_abs(ref[k] - TestVal);
...
int main(int , char** )
{
  ...
  rtk::ImportImageFilter< itk::Image<unsigned int,2> >::Pointer vol = rtk::ImportImageFilter< itk::Image<unsigned int,2> >::New();
  ...
  rtk::ImportImageFilter< itk::Image<double,2> >::Pointer volDouble = rtk::ImportImageFilter< itk::Image<double,2> >::New();
