...
public:
  ...
  required_option_gen_class(bool           _checkrange,
                            const string & _mode_condition,
  ...
  void
  set_checkrange(bool _checkrange)
  {
    checkrange = _checkrange;
  }

  void
  set_mode_condition(const string & _mode_condition)
  {
    mode_condition = _mode_condition;
  }
  ...
  void
  generate_required_option(ostream & stream, unsigned int indent = 0);
};
