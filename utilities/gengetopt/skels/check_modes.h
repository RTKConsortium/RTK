...
public:
  ...
  check_modes_gen_class(const string & _mode1_given_fields,
                        const string & _mode1_name,
                        const string & _mode1_options,
                        const string & _mode2_given_fields,
                        const string & _mode2_name,
                        const string & _mode2_options)
  ...
  void
  set_mode1_given_fields(const string & _mode1_given_fields)
  {
    mode1_given_fields = _mode1_given_fields;
  }

  void
  set_mode1_name(const string & _mode1_name)
  {
    mode1_name = _mode1_name;
  }

  void
  set_mode1_options(const string & _mode1_options)
  {
    mode1_options = _mode1_options;
  }

  void
  set_mode2_given_fields(const string & _mode2_given_fields)
  {
    mode2_given_fields = _mode2_given_fields;
  }

  void
  set_mode2_name(const string & _mode2_name)
  {
    mode2_name = _mode2_name;
  }

  void
  set_mode2_options(const string & _mode2_options)
  {
    mode2_options = _mode2_options;
  }
