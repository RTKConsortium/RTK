...
public:
  ...
  dependant_option_gen_class(const string & _dep_option,
                             const string & _dep_option_descr,
                             const string & _option_descr,
  ...
  void
  set_dep_option(const string & _dep_option)
  {
    dep_option = _dep_option;
  }

  void
  set_dep_option_descr(const string & _dep_option_descr)
  {
    dep_option_descr = _dep_option_descr;
  }

  void
  set_option_descr(const string & _option_descr)
  {
    option_descr = _option_descr;
  }
  ...
  void
  generate_dependant_option(ostream & stream, unsigned int indent = 0);
};
