...
public:
  ...
  void
  set_arg(const string & _arg)
  {
    arg = _arg;
  }

  void
  set_given(const string & _given)
  {
    given = _given;
  }

  void
  set_opt_name(const string & _opt_name)
  {
    opt_name = _opt_name;
  }

  void
  set_values(const string & _values)
  {
    values = _values;
  }

  void
  generate_file_save(ostream & stream, unsigned int indent = 0);
};
