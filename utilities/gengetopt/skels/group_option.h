...
public:
  ...
  group_option_gen_class(const string & _Comparison_rule,
                         const string & _group_name,
                         const string & _group_var_name,
                         const string & _number_required,
  ...
  void
  set_Comparison_rule(const string & _Comparison_rule)
  {
    Comparison_rule = _Comparison_rule;
  }

  void
  set_group_name(const string & _group_name)
  {
    group_name = _group_name;
  }
  ...
  void
  set_number_required(const string & _number_required)
  {
    number_required = _number_required;
  }
  ...
  void
  generate_group_option(ostream & stream, unsigned int indent = 0);
};
