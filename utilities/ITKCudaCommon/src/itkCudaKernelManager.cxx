...
bool CudaKernelManager::PushKernelArg(int kernelIdx, const void* argVal)
{
  ...
  m_KernelArgumentReady[kernelIdx][argIdx].m_CudaDataManager = (CudaDataManager *)ITK_NULLPTR;
...
void CudaKernelManager::ResetArguments(int kernelIdx)
{
  ...
  for (int i = 0; i < nArg; i++)
    ...
    m_KernelArgumentReady[kernelIdx][i].m_CudaDataManager = (CudaDataManager *)ITK_NULLPTR;
    }
}
