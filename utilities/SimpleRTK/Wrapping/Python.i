...
def GetImageFromArray( arr, isVector=False):
    """Get a SimpleRTK Image from a numpy array. If isVector is True, then a 3D array will be treaded as a 2D vector image, otherwise it will be treaded as a 3D image"""
...
%extend rtk::simple::ProcessObject {
 int AddCommand( EventEnum e, PyObject *obj )
 {
