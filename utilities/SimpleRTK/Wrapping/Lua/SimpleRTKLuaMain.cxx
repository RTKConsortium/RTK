...
static void print_version (void) {
  ...
  fprintf ( stdout, "Simple ITK:\n%s\n", rtk::simple::Version::ExtendedVersionString().c_str() );
}
...
extern "C" int luaopen_SimpleRTK ( lua_State* L );
...
int main (int argc, char **argv) {
  ...
  gl_configure_getline ( gl, "", "", "~/.SimpleRTKLua" );
  gl_load_history ( gl, "~/.SimpleRTK.history", "--" );
#endif
...
#ifdef USE_TECLA
  gl_save_history ( gl, "~/.SimpleRTK.history", "--", 1000 );
  del_GetLine ( gl );
#endif
