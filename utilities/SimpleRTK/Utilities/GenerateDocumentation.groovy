...
// Find some options...
def XMLFileOptions = ["classrtk_1_1" + definition.itk_name + ".xml",
                      "classrtk_1_1" + definition.name + definition.template_code_filename + ".xml",
                      "classrtk_1_1" + definition.name + ".xml"]
...
def ClassName = doc.compounddef.compoundname.text().replaceAll ( "itk::", "rtk::simple::" )
