 ...
 *
 *=========================================================================*/
#ifndef __srtkImageSeriesReader_h
#define __srtkImageSeriesReader_h
...
namespace rtk {
  namespace simple {
     ...
     * \brief Read series of image into a SimpleRTK image
     *
     * \sa rtk::simple::ReadImage for the procedural interface
     **/
    class SRTKIO_EXPORT ImageSeriesReader
