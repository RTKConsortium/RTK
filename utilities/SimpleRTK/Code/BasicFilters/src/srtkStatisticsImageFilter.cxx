...
// Functional interface
  rtk::simple::MeasurementMap Statistics ( const Image& image )
  {
...
std::string StatisticsImageFilter::ToString() const
  ...
  out << "rtk::simple::StatisticsImageFilter\n";
...
rtk::simple::MeasurementMap StatisticsImageFilter::GetMeasurementMap( ) const
  {
