 ...
 *
 *=========================================================================*/
#ifndef __srtkStatisticsImageFilter_h
#define __srtkStatisticsImageFilter_h
...
namespace rtk {
  namespace simple {
     ...
     *
     * \sa rtk::simple::Statistics for the procedural interface
     */
    class SRTKBasicFilters_EXPORT StatisticsImageFilter : public ImageFilter<1> {
    public:
      ...
      rtk::simple::MeasurementMap GetMeasurementMap ( ) const;
    private:
    ...
    SRTKBasicFilters_EXPORT rtk::simple::MeasurementMap Statistics ( const Image& );
  }
}
#endif
