 ...
 *
 *=========================================================================*/
#ifndef __srtkCastImageFilter_h
#define __srtkCastImageFilter_h
 ...
 *
 * \sa rtk::simple::Cast for the procedural interface
 */
class SRTKBasicFilters_EXPORT CastImageFilter
...
// SWIG does not appear to process private classes correctly
  ...
  */
  ...
  SRTKBasicFilters_EXPORT Image Cast ( const Image& image, PixelIDValueEnum pixelID );
