 ...
 *
 *=========================================================================*/
#ifndef __srtkLabelStatisticsImageFilter_h
#define __srtkLabelStatisticsImageFilter_h
...
namespace rtk {
  namespace simple {
     ...
     * input image.
     *
     * \sa rtk::simple::LabelStatistics for the procedural interface
     */
    class SRTKBasicFilters_EXPORT  LabelStatisticsImageFilter
  ...
  SRTKBasicFilters_EXPORT LabelStatisticsImageFilter::LabelStatisticsMap LabelStatistics ( const Image& image1, const Image& labelImage, bool useHistograms = true );
  }
}
#endif
