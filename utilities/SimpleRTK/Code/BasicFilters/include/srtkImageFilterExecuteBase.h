...
*
*=========================================================================*/
#ifndef __srtkImageFilterExecuteBase_h
#define  __srtkImageFilterExecuteBase_h
...
namespace rtk {
  ...
  template <>
  struct SRTKBasicFilters0_EXPORT ImageFilterExecuteBase<0> : public rtk::simple::ProcessObject
  {
  ...
  template <>
  struct SRTKBasicFilters0_EXPORT ImageFilterExecuteBase<1> : public ProcessObject
  {
    virtual ~ImageFilterExecuteBase();
  ...
  template <>
  struct SRTKBasicFilters0_EXPORT ImageFilterExecuteBase<2> : public ProcessObject
  {
    virtual ~ImageFilterExecuteBase();
  ...
  template <>
  struct SRTKBasicFilters0_EXPORT ImageFilterExecuteBase<3> : public ProcessObject
  {
    virtual ~ImageFilterExecuteBase();
  ...
  template <>
  struct SRTKBasicFilters0_EXPORT ImageFilterExecuteBase<4> : public ProcessObject
  {
    virtual ~ImageFilterExecuteBase();
  ...
  template <>
  struct SRTKBasicFilters0_EXPORT ImageFilterExecuteBase<5> : public ProcessObject
  {
    virtual ~ImageFilterExecuteBase();
...
#endif //  __srtkImageFilterExecuteBase_h
