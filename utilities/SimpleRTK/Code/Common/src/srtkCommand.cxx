...
Command::~Command( )
{
  ...
  std::set<rtk::simple::ProcessObject*>::iterator i = m_ReferencedObjects.begin();
...
size_t Command::AddProcessObject(rtk::simple::ProcessObject *o)
{
...
size_t Command::RemoveProcessObject(const rtk::simple::ProcessObject *co)
{
