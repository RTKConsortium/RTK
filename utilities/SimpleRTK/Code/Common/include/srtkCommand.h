 ...
 *
 *=========================================================================*/
#ifndef __srtkCommand_h
#define __srtkCommand_h
 ...
 */
class SRTKCommon_EXPORT Command:
...
protected:
  ...
  friend class rtk::simple::ProcessObject;
  ...
  // operation.
  virtual size_t AddProcessObject(rtk::simple::ProcessObject *o);
  virtual size_t RemoveProcessObject(const rtk::simple::ProcessObject *o);
...
private:
  ...
  std::set<rtk::simple::ProcessObject*> m_ReferencedObjects;
