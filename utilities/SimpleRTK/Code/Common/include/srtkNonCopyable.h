 ...
 *
 *=========================================================================*/
#ifndef __srtkNonCopyable_h
#define __srtkNonCopyable_h
...
*
*/
class SRTKCommon_EXPORT NonCopyable
{
protected:
  NonCopyable() {}
private:
...
#if SRTK_EXPLICIT_DEFAULT_DELETE_FUNCTIONS
