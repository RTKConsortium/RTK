 ...
 *
 *=========================================================================*/
#ifndef __srtkPixelIDTypeLists_h
#define __srtkPixelIDTypeLists_h

#include <stdint.h>

#include "srtkConfigure.h"
#include "srtkPixelIDTypes.h"
...
#ifdef SRTK_EXPRESS_INSTANTIATEDPIXELS
...
/** List of pixel ids which are instantiated for use in SimpleRTK
 *
