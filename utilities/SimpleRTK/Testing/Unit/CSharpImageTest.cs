using System;
using rtk.simple;
using srtk = rtk.simple;
using PixelId = rtk.simple.PixelIDValueEnum;

namespace rtk.simple {
    /// <summary>Test rtk.simple.Image.</summary>
    public class CSharpImageTest {
        ...
        public static int Main (string[] args) {
            ...
            try {
                Image image = new Image(100, 100, PixelId.srtkInt8);
                Image image2 = new Image(100, 100, PixelId.srtkInt8);
