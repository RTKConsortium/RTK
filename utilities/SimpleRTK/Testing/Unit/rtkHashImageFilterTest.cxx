...
TEST_F(HashImageFilterTest, LabelMap ) {
  ...
  rtk::simple::Image img = rtk::simple::ReadImage( dataFinder.GetFile ( "Input/2th_cthead1.png" ) );

  std::string hash;

  EXPECT_NO_THROW( hash = rtk::simple::Hash( rtk::simple::Cast( img, rtk::simple::srtkLabelUInt16 ) ) );
  EXPECT_EQ( hash, "134248ff026387fe17bd0bfa62357fa390d52985" );

  EXPECT_NO_THROW( hash = rtk::simple::Hash( rtk::simple::Cast( img, rtk::simple::srtkLabelUInt32 ) ) );
