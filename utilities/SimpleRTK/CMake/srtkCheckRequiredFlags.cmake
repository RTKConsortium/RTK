...
#   SimpleRTK_REQUIRED_C_FLAGS
#   SimpleRTK_REQUIRED_CXX_FLAGS
#   SimpleRTK_REQUIRED_LINK_FLAGS
#
...
if( NOT DEFINED SimpleRTK_REQUIRED_C_FLAGS )
  set(SimpleRTK_REQUIRED_C_FLAGS "")
endif()
if( NOT DEFINED SimpleRTK_REQUIRED_CXX_FLAGS )
  set(SimpleRTK_REQUIRED_CXX_FLAGS "")
endif()
...
# SimpleRTK_REQUIRED_CXX_FLAGS variable.
#

string(REPLACE " " ";" cmake_cxx_flags_list "${CMAKE_CXX_FLAGS}")

# list of regular expressions flags that are to be required flags for SimpleRTK
...
foreach(f ${cmake_cxx_flags_list})
  foreach( _r ${required_flags_regex_to_test} )
    ...
    if (_HAS_FLAG )
      string(FIND "${SimpleRTK_REQUIRED_CXX_FLAGS}" "${f}" required)
      if(required LESS 0)
        set(SimpleRTK_REQUIRED_CXX_FLAGS "${SimpleRTK_REQUIRED_CXX_FLAGS} ${f}")
      endif()
    endif()
  endforeach()
endforeach()
...
string(FIND "${SimpleRTK_REQUIRED_CXX_FLAGS}" "-std=c++11" required)
if(required LESS 0)
  ...
  if (CXX_HAS_stdcxx11)
    ...
    try_compile(SRTK_CHECK_CXX11_REQUIRED
      "${PROJECT_BINARY_DIR}/CMakeTmp"
      "${CMAKE_CURRENT_LIST_DIR}/srtk_check_cxx11_required.cxx"
      OUTPUT_VARIABLE OUTPUT)
    if(${SRTK_CHECK_CXX11_REQUIRED})
      ...
      file(APPEND ${CMAKE_BINARY_DIR}/${CMAKE_FILES_DIRECTORY}/CMakeError.log
        ...
        "${OUTPUT}\n")
      set(SimpleRTK_REQUIRED_CXX_FLAGS "${SimpleRTK_REQUIRED_CXX_FLAGS} -std=c++11")
    endif()
