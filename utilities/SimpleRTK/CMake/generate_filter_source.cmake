...
macro( expand_template FILENAME input_dir output_dir library_name )
  ...
  add_custom_command (
    ...
    COMMAND lua ${expand_template_script} code ${input_json_file} ${input_dir}/templates/srtk ${template_include_dir} Template.h.in ${output_h}
  ...
  add_custom_command (
    ...
    COMMAND lua ${expand_template_script} code ${input_json_file} ${input_dir}/templates/srtk ${template_include_dir} Template.cxx.in ${output_cxx}
...
macro(generate_filter_source)
  ...
  file ( WRITE ${generated_code_output_path}/include/SimpleRTK${directory_name}GeneratedHeaders.h "" )
  file ( WRITE ${generated_code_output_path}/include/SimpleRTK${directory_name}GeneratedHeaders.i "" )
  ...
  # Add ifndefs
  file ( APPEND ${generated_headers_h} "#ifndef __SimpleRTK${directory_name}GeneratedHeaders_h\n")
  file ( APPEND ${generated_headers_h} "#define __SimpleRTK${directory_name}GeneratedHeaders_h\n")

  foreach ( filter ${GENERATED_FILTER_LIST} )
    file ( APPEND ${generated_headers_h} "#include \"srtk${filter}.h\"\n" )
    file ( APPEND ${generated_headers_i} "%include \"srtk${filter}.h\"\n" )
  endforeach()
