...
if(NOT ${_GIT_VERSION_RC} STREQUAL "" )
  set(SimpleRTK_VERSION_RC "${_GIT_VERSION_RC}")
endif()


# The hash is the current git sha1 hash tag of the HEAD.
set(SimpleRTK_VERSION_HASH "${_GIT_VERSION_HASH}")
...
if(DEFINED _GIT_VERSION_POST)
  set(SimpleRTK_VERSION_POST "${_GIT_VERSION_POST}")
elseif(DEFINED _GIT_VERSION_DEV)
  set(SimpleRTK_VERSION_DEV "${_GIT_VERSION_DEV}")
endif()
