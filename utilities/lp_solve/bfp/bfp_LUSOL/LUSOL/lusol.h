...
#define LUSOL_UPDATE_NEWNONEMPTY                                    \
  1                                /* v(*) contains the new column; \
...
/* ------------------------------------------------------------------------- */
typedef void
LUSOLlogfunc(void * lp, void * userhandle, char * buf);
...
MYBOOL
LU1L0(LUSOLrec * LUSOL, LUSOLmat ** mat, int * inform);
void
LU6SOL(LUSOLrec * LUSOL, int MODE, REAL V[], REAL W[], int NZidx[], int * INFORM);
void
LU8RPC(LUSOLrec * LUSOL, int MODE1, int MODE2, int JREP, REAL V[], REAL W[], int * INFORM, REAL * DIAG, REAL * VNORM);
