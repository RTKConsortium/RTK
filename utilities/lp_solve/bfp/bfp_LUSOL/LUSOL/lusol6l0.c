...
LU1L0(LUSOLrec * LUSOL, LUSOLmat ** mat, int * inform)
{
  ...
  *inform = LUSOL_INFORM_LUSUCCESS;
  ...
  if ((NUML0 == 0) || (LENL0 == 0) || (LUSOL->luparm[LUSOL_IP_ACCELERATION] == LUSOL_BASEORDER) ||
  ...
  if ((LUSOL->luparm[LUSOL_IP_ACCELERATION] & LUSOL_AUTOORDER) && ((REAL)LUSOL->luparm[LUSOL_IP_ROWCOUNT_L0] /
#if 0
...
void
LU6L0T_v(LUSOLrec * LUSOL, LUSOLmat * mat, REAL V[], int NZidx[], int * INFORM)
{
