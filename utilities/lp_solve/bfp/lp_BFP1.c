...
bfp_compatible(lprec * lp, int bfpversion, int lpversion, int sizeofvar)
{
...
/* DON'T MODIFY */
int BFP_CALLMODEL
bfp_refactcount(lprec * lp, int kind)
{
...
void BFP_CALLMODEL
bfp_updaterefactstats(lprec * lp)
{
  INVrec * lu = lp->invB;
