...
void __WINAPI
lp_solve_version(int * majorversion, int * minorversion, int * release, int * build)
{
...
MYBOOL __WINAPI
userabort(lprec * lp, int message)
{
  MYBOOL abort;
  int    spx_save;
...
STATIC int
yieldformessages(lprec * lp)
{
  if ((lp->sectimeout > 0) && ((timeNow() - lp->timestart) - (REAL)lp->sectimeout > 0))
...
void __WINAPI
set_outputstream(lprec * lp, FILE * stream)
{
...
MYBOOL __WINAPI
set_outputfile(lprec * lp, const char * filename)
{
  MYBOOL ok;
  FILE * output = stdout;
...
void __WINAPI
put_bb_nodefunc(lprec * lp, lphandleint_intfunc newnode, void * bbnodehandle)
{
  lp->bb_usenode = newnode;
  lp->bb_nodehandle = bbnodehandle; /* User-specified "owner process ID" */
}
void __WINAPI
put_bb_branchfunc(lprec * lp, lphandleint_intfunc newbranch, void * bbbranchhandle)
{
  lp->bb_usebranch = newbranch;
  lp->bb_branchhandle = bbbranchhandle; /* User-specified "owner process ID" */
}
void __WINAPI
put_abortfunc(lprec * lp, lphandle_intfunc newctrlc, void * ctrlchandle)
{
  lp->ctrlc = newctrlc;
  lp->ctrlchandle = ctrlchandle; /* User-specified "owner process ID" */
}
void __WINAPI
put_logfunc(lprec * lp, lphandlestr_func newlog, void * loghandle)
{
  lp->writelog = newlog;
  lp->loghandle = loghandle; /* User-specified "owner process ID" */
}
void __WINAPI
put_msgfunc(lprec * lp, lphandleint_func newmsg, void * msghandle, int mask)
{
...
/* ---------------------------------------------------------------------------------- */
lprec * __WINAPI
read_MPS(char * filename, int options)
{
  lprec * lp = NULL;
  int     typeMPS;
...
lprec * __WINAPI
read_mps(FILE * filename, int options)
{
  lprec * lp = NULL;
  int     typeMPS;
...
/* #if defined develop */
lprec * __WINAPI
read_mpsex(void * userhandle, read_modeldata_func read_modeldata, int options)
{
  lprec * lp = NULL;
  int     typeMPS;
...
/* #endif */
lprec * __WINAPI
read_freeMPS(char * filename, int options)
{
  lprec * lp = NULL;
  int     typeMPS;
...
lprec * __WINAPI
read_freemps(FILE * filename, int options)
{
  lprec * lp = NULL;
  int     typeMPS;
...
/* #if defined develop */
lprec * __WINAPI
read_freempsex(void * userhandle, read_modeldata_func read_modeldata, int options)
{
  lprec * lp = NULL;
  int     typeMPS;
...
/* #endif */
MYBOOL __WINAPI
write_mps(lprec * lp, const char * filename)
{
...
MYBOOL __WINAPI
write_freemps(lprec * lp, const char * filename)
{
  return (MPS_writefile(lp, MPSFREE, filename));
}
MYBOOL __WINAPI
write_freeMPS(lprec * lp, FILE * output)
{
  return (MPS_writehandle(lp, MPSFREE, output));
}

MYBOOL __WINAPI
write_lp(lprec * lp, const char * filename)
{
...
#ifndef PARSER_LP
MYBOOL __WINAPI
LP_readhandle(lprec ** lp, FILE * filename, int verbose, const char * lp_name)
{
  return (FALSE);
}
lprec * __WINAPI
read_lp(FILE * filename, int verbose, const char * lp_name)
{
  return (NULL);
}
lprec * __WINAPI
read_LP(char * filename, int verbose, const char * lp_name)
{
  return (NULL);
}
#endif
...
MYBOOL __WINAPI
write_basis(lprec * lp, const char * filename)
{
  int typeMPS = MPSFIXED;
  return (MPS_writeBAS(lp, typeMPS, filename));
}
MYBOOL __WINAPI
read_basis(lprec * lp, const char * filename, char * info)
{
  int typeMPS = MPSFIXED;
...
void __WINAPI
print_tableau(lprec * lp)
{
  REPORT_tableau(lp);
}
void __WINAPI
print_objective(lprec * lp)
{
  REPORT_objective(lp);
}
void __WINAPI
print_solution(lprec * lp, int columns)
{
  REPORT_solution(lp, columns);
}
void __WINAPI
print_constraints(lprec * lp, int columns)
{
...
MYBOOL __WINAPI
print_debugdump(lprec * lp, const char * filename)
{
  return (REPORT_debugdump(lp, filename, (MYBOOL)(get_total_iter(lp) > 0)));
}
void __WINAPI
print_str(lprec * lp, const char * str)
{
...
void __WINAPI
set_timeout(lprec * lp, long sectimeout)
{
  lp->sectimeout = sectimeout;
}

long __WINAPI
get_timeout(lprec * lp)
{
  return (lp->sectimeout);
}

void __WINAPI
set_verbose(lprec * lp, int verbose)
{
  lp->verbose = verbose;
}

int __WINAPI
get_verbose(lprec * lp)
{
  return (lp->verbose);
}

void __WINAPI
set_print_sol(lprec * lp, int print_sol)
{
  lp->print_sol = print_sol;
}

int __WINAPI
get_print_sol(lprec * lp)
{
  return (lp->print_sol);
}

void __WINAPI
set_debug(lprec * lp, MYBOOL debug)
{
  lp->bb_trace = debug;
}
...
void __WINAPI
set_trace(lprec * lp, MYBOOL trace)
{
  lp->spx_trace = trace;
}
...
void __WINAPI
set_anti_degen(lprec * lp, int anti_degen)
{
  lp->anti_degen = anti_degen;
}

int __WINAPI
get_anti_degen(lprec * lp)
{
  return (lp->anti_degen);
}

MYBOOL __WINAPI
is_anti_degen(lprec * lp, int testmask)
{
  return ((MYBOOL)((lp->anti_degen == testmask) || ((lp->anti_degen & testmask) != 0)));
}

void __WINAPI
set_presolve(lprec * lp, int presolvemode, int maxloops)
{
  presolvemode &=
    ~PRESOLVE_REDUCEMIP; /* disable PRESOLVE_REDUCEMIP since it is very rare that this is effective, and also that it
                            adds code complications and delayed presolve effects that are not captured properly. */
  lp->do_presolve = presolvemode;
  lp->presolveloops = maxloops;
}

int __WINAPI
get_presolve(lprec * lp)
{
  return (lp->do_presolve);
}

int __WINAPI
get_presolveloops(lprec * lp)
{
...
MYBOOL __WINAPI
is_presolve(lprec * lp, int testmask)
{
  return ((MYBOOL)((lp->do_presolve == testmask) || ((lp->do_presolve & testmask) != 0)));
}

void __WINAPI
set_maxpivot(lprec * lp, int maxpivot)
{
  lp->max_pivots = maxpivot;
}

int __WINAPI
get_maxpivot(lprec * lp)
{
  return (lp->bfp_pivotmax(lp));
}

void __WINAPI
set_bb_rule(lprec * lp, int bb_rule)
{
  lp->bb_rule = bb_rule;
}

int __WINAPI
get_bb_rule(lprec * lp)
{
  return (lp->bb_rule);
}

/* INLINE */ MYBOOL
is_bb_rule(lprec * lp, int bb_rule) { return ((MYBOOL)((lp->bb_rule & NODE_STRATEGYMASK) == bb_rule)); }

/* INLINE */ MYBOOL
is_bb_mode(lprec * lp, int bb_mask) { return ((MYBOOL)((lp->bb_rule & bb_mask) > 0)); }

void __WINAPI
set_action(int * actionvar, int actionmask)
{
  *actionvar |= actionmask;
}

void __WINAPI
clear_action(int * actionvar, int actionmask)
{
  *actionvar &= ~actionmask;
}

MYBOOL __WINAPI
is_action(int actionvar, int testmask)
{
  return ((MYBOOL)((actionvar & testmask) != 0));
}

void __WINAPI
set_bb_depthlimit(lprec * lp, int bb_maxlevel)
{
  lp->bb_limitlevel = bb_maxlevel;
}

int __WINAPI
get_bb_depthlimit(lprec * lp)
{
  return (lp->bb_limitlevel);
}

void __WINAPI
set_obj_bound(lprec * lp, REAL bb_heuristicOF)
{
  lp->bb_heuristicOF = bb_heuristicOF;
}

REAL __WINAPI
get_obj_bound(lprec * lp)
{
  return (lp->bb_heuristicOF);
}

void __WINAPI
set_mip_gap(lprec * lp, MYBOOL absolute, REAL mip_gap)
{
  if (absolute)
...
REAL __WINAPI
get_mip_gap(lprec * lp, MYBOOL absolute)
{
  if (absolute)
...
MYBOOL __WINAPI
set_var_branch(lprec * lp, int colnr, int branch_mode)
{
...
int __WINAPI
get_var_branch(lprec * lp, int colnr)
{
  if (colnr > lp->columns || colnr < 1)
  {
...
static void
set_infiniteex(lprec * lp, REAL infinite, MYBOOL init)
{
  int i;
...
MYBOOL __WINAPI
is_infinite(lprec * lp, REAL value)
{
#if 1
...
void __WINAPI
set_infinite(lprec * lp, REAL infinite)
{
  set_infiniteex(lp, infinite, FALSE);
}

REAL __WINAPI
get_infinite(lprec * lp)
{
  return (lp->infinite);
}

void __WINAPI
set_epsperturb(lprec * lp, REAL epsperturb)
{
  lp->epsperturb = epsperturb;
}

REAL __WINAPI
get_epsperturb(lprec * lp)
{
  return (lp->epsperturb);
}

void __WINAPI
set_epspivot(lprec * lp, REAL epspivot)
{
  lp->epspivot = epspivot;
}

REAL __WINAPI
get_epspivot(lprec * lp)
{
  return (lp->epspivot);
}

void __WINAPI
set_epsint(lprec * lp, REAL epsint)
{
  lp->epsint = epsint;
}
...
MYBOOL __WINAPI
set_epslevel(lprec * lp, int epslevel)
{
...
void __WINAPI
set_scaling(lprec * lp, int scalemode)
{
  lp->scalemode = scalemode;
}

int __WINAPI
get_scaling(lprec * lp)
{
  return (lp->scalemode);
}

MYBOOL __WINAPI
is_scalemode(lprec * lp, int testmask)
{
  return ((MYBOOL)((lp->scalemode & testmask) != 0));
}

MYBOOL __WINAPI
is_scaletype(lprec * lp, int scaletype)
{
  int testtype;
...
void __WINAPI
set_scalelimit(lprec * lp, REAL scalelimit)
...
REAL __WINAPI
get_scalelimit(lprec * lp)
{
  return (lp->scalelimit);
}

MYBOOL __WINAPI
is_integerscaling(lprec * lp)
{
  return (is_scalemode(lp, SCALE_INTEGERS));
}

void __WINAPI
set_improve(lprec * lp, int improve)
{
  lp->improve = improve;
}

int __WINAPI
get_improve(lprec * lp)
{
  return (lp->improve);
}

void __WINAPI
set_lag_trace(lprec * lp, MYBOOL lag_trace)
{
  lp->lag_trace = lag_trace;
}

MYBOOL __WINAPI
is_lag_trace(lprec * lp)
{
  return (lp->lag_trace);
}

void __WINAPI
set_pivoting(lprec * lp, int pivoting)
{
...
MYBOOL __WINAPI
is_piv_rule(lprec * lp, int rule)
{
  return ((MYBOOL)(get_piv_rule(lp) == rule));
}

MYBOOL __WINAPI
is_piv_mode(lprec * lp, int testmask)
{
  return ((MYBOOL)(((testmask & PRICE_STRATEGYMASK) != 0) && ((lp->piv_strategy & testmask) != 0)));
}

void __WINAPI
set_break_at_first(lprec * lp, MYBOOL break_at_first)
{
  lp->bb_breakfirst = break_at_first;
}

MYBOOL __WINAPI
is_break_at_first(lprec * lp)
{
  return (lp->bb_breakfirst);
}

void __WINAPI
set_bb_floorfirst(lprec * lp, int bb_floorfirst)
{
  lp->bb_floorfirst = (MYBOOL)bb_floorfirst;
}

int __WINAPI
get_bb_floorfirst(lprec * lp)
{
  return (lp->bb_floorfirst);
}

void __WINAPI
set_break_at_value(lprec * lp, REAL break_at_value)
{
  lp->bb_breakOF = break_at_value;
}

REAL __WINAPI
get_break_at_value(lprec * lp)
{
  return (lp->bb_breakOF);
}

void __WINAPI
set_negrange(lprec * lp, REAL negrange)
{
  if (negrange <= 0)
...
REAL __WINAPI
get_negrange(lprec * lp)
{
  return (lp->negrange);
}

int __WINAPI
get_max_level(lprec * lp)
{
  return (lp->bb_maxlevel);
}

COUNTER __WINAPI
get_total_nodes(lprec * lp)
{
  return (lp->bb_totalnodes);
}

COUNTER __WINAPI
get_total_iter(lprec * lp)
{
  return (lp->total_iter + lp->current_iter);
}

REAL __WINAPI
get_objective(lprec * lp)
{
...
int __WINAPI
get_nonzeros(lprec * lp)
{
  return (mat_nonzeros(lp->matA));
}

MYBOOL __WINAPI
set_mat(lprec * lp, int rownr, int colnr, REAL value)
{
...
REAL __WINAPI
get_working_objective(lprec * lp)
{
  REAL value = 0.0;
...
REAL __WINAPI
get_var_primalresult(lprec * lp, int index)
{
...
REAL __WINAPI
get_var_dualresult(lprec * lp, int index)
{
  REAL * duals;
...
MYBOOL __WINAPI
get_variables(lprec * lp, REAL * var)
{
  if (lp->spx_status == OPTIMAL)
    ;
  else if (!lp->basis_valid)
...
MYBOOL __WINAPI
get_ptr_variables(lprec * lp, REAL ** var)
{
  if (lp->spx_status == OPTIMAL)
    ;
  else if (!lp->basis_valid)
...
MYBOOL __WINAPI
get_constraints(lprec * lp, REAL * constr)
{
  if (lp->spx_status == OPTIMAL)
    ;
  else if (!lp->basis_valid)
...
MYBOOL __WINAPI
get_ptr_constraints(lprec * lp, REAL ** constr)
{
  if (lp->spx_status == OPTIMAL)
    ;
  else if (!lp->basis_valid)
...
MYBOOL __WINAPI
get_sensitivity_rhs(lprec * lp, REAL * duals, REAL * dualsfrom, REAL * dualstill)
{
...
MYBOOL __WINAPI
get_ptr_sensitivity_rhs(lprec * lp, REAL ** duals, REAL ** dualsfrom, REAL ** dualstill)
{
  if (!lp->basis_valid)
  {
...
MYBOOL __WINAPI
get_sensitivity_objex(lprec * lp, REAL * objfrom, REAL * objtill, REAL * objfromvalue, REAL * objtillvalue)
{
  ...
  if (!get_ptr_sensitivity_objex(lp,
                                 (objfrom != NULL) ? &objfrom0 : NULL,
...
MYBOOL __WINAPI
get_sensitivity_obj(lprec * lp, REAL * objfrom, REAL * objtill)
{
  return (get_sensitivity_objex(lp, objfrom, objtill, NULL, NULL));
}

MYBOOL __WINAPI
get_ptr_sensitivity_objex(lprec * lp, REAL ** objfrom, REAL ** objtill, REAL ** objfromvalue, REAL ** objtillvalue)
{
  if (!lp->basis_valid)
  {
...
MYBOOL __WINAPI
get_ptr_sensitivity_obj(lprec * lp, REAL ** objfrom, REAL ** objtill)
{
  return (get_ptr_sensitivity_objex(lp, objfrom, objtill, NULL, NULL));
}

void __WINAPI
set_solutionlimit(lprec * lp, int limit)
{
  lp->solutionlimit = limit;
}
int __WINAPI
get_solutionlimit(lprec * lp)
{
  return (lp->solutionlimit);
}
int __WINAPI
get_solutioncount(lprec * lp)
{
...
int __WINAPI
get_Ncolumns(lprec * lp)
{
  return (lp->columns);
}

int __WINAPI
get_Norig_columns(lprec * lp)
{
  if (lp->varmap_locked)
...
const char * __WINAPI
get_statustext(lprec * lp, int statuscode)
{
  (void)lp;
  if (statuscode == NOBFP)
    return ("No basis factorization package");
...
MYBOOL __WINAPI
resize_lp(lprec * lp, int rows, int columns)
{
  MYBOOL status = TRUE;
...
delete_lp(lprec * lp)
{
  ...
  if (lp->bb_bounds != NULL)
  {
    report(lp,
           SEVERE,
           "delete_lp: The stack of B&B levels was not empty (failed at %.0f nodes)\n",
...
static MYBOOL
get_SOS(lprec * lp, int index, char * name, int * sostype, int * priority, int * count, int * sosvars, REAL * weights)
{
  SOSrec * SOS;
...
copy_lp(lprec * lp)
{
  ...
  if (!allocINT(lp, &idx, rows + 1, FALSE) || !allocREAL(lp, &val, rows + 1, FALSE))
    goto Finish;
  ...
  for (i = 1; get_SOS(lp, i, buf, &sostype, &priority, &count, NULL, NULL); i++)
    if (count)
    {
      if (!allocINT(lp, &sosvars, count, FALSE) || !allocREAL(lp, &weights, count, FALSE))
        n = 0;
      else
      {
...
STATIC MYBOOL
memopt_lp(lprec * lp, int rowextra, int colextra, int nzextra)
{
  MYBOOL status = FALSE;
  ...
  status = mat_memopt(lp->matA, rowextra, colextra, nzextra) && (++rowextra > 0) && (++colextra > 0) && (++nzextra > 0);
...
STATIC void
varmap_add(lprec * lp, int base, int delta)
{
  int               i, ii;
  presolveundorec * psundo = lp->presolve_undo;
...
STATIC void
varmap_delete(lprec * lp, int base, int delta, LLrec * varmap)
{
  int               i, ii, j;
...
STATIC MYBOOL
varmap_validate(lprec * lp, int varno)
{
  MYBOOL success = TRUE;
  int    i, ii, ix, ie, n_rows = lp->rows, orig_sum = lp->presolve_undo->orig_sum,
...
STATIC void
varmap_compact(lprec * lp, int prev_rows, int prev_cols)
{
  presolveundorec * psundo = lp->presolve_undo;
  int               i, ii, n_sum, n_rows, orig_rows = psundo->orig_rows, prev_sum = prev_rows + prev_cols;
...
STATIC MYBOOL
shift_rowcoldata(lprec * lp, int base, int delta, LLrec * usedmap, MYBOOL isrow)
/* Note: Assumes that "lp->sum" and "lp->rows" HAVE NOT been updated to the new counts */
{
  ...
  else if (usedmap != NULL)
  {
    ...
    if (!isrow)
      offset += lp->rows;
    i = offset + 1;
    for (k = firstActiveLink(usedmap); k != 0; i++, k = nextActiveLink(usedmap, k))
    {
      ii = k + offset;
      if (ii == i)
        continue;
...
STATIC MYBOOL
shift_basis(lprec * lp, int base, int delta, LLrec * usedmap, MYBOOL isrow)
/* Note: Assumes that "lp->sum" and "lp->rows" HAVE NOT been updated to the new counts */
{
  (void)usedmap;
  int    i, ii;
...
STATIC MYBOOL
shift_rowdata(lprec * lp, int base, int delta, LLrec * usedmap)
/* Note: Assumes that "lp->rows" HAS NOT been updated to the new count */
{
  ...
  {
    for (i = 1, ii = firstActiveLink(usedmap); ii != 0; i++, ii = nextActiveLink(usedmap, ii))
    {
      if (i == ii)
        continue;
      lp->orig_rhs[i] = lp->orig_rhs[ii];
...
STATIC MYBOOL
shift_coldata(lprec * lp, int base, int delta, LLrec * usedmap)
...
STATIC void
inc_columns(lprec * lp, int delta)
{
  int i;
...
STATIC MYBOOL
inc_rowcol_space(lprec * lp, int delta, MYBOOL isrows)
{
  ...
  if (!allocREAL(lp, &lp->upbo, rowcolsum, AUTOMATIC) || !allocREAL(lp, &lp->orig_upbo, rowcolsum, AUTOMATIC) ||
      !allocREAL(lp, &lp->lowbo, rowcolsum, AUTOMATIC) || !allocREAL(lp, &lp->orig_lowbo, rowcolsum, AUTOMATIC) ||
      !allocREAL(lp, &lp->solution, rowcolsum, AUTOMATIC) || !allocREAL(lp, &lp->best_solution, rowcolsum, AUTOMATIC) ||
      !allocMYBOOL(lp, &lp->is_basic, rowcolsum, AUTOMATIC) || !allocMYBOOL(lp, &lp->is_lower, rowcolsum, AUTOMATIC) ||
  ...
  return (inc_presolve_space(lp, delta, isrows) && resizePricer(lp));
}

STATIC MYBOOL
inc_lag_space(lprec * lp, int deltarows, MYBOOL ignoreMAT)
{
  int newsize;
  ...
  if (deltarows > 0)
  {
    ...
    /* Reallocate arrays */
    if (!allocREAL(lp, &lp->lag_rhs, newsize + 1, AUTOMATIC) || !allocREAL(lp, &lp->lambda, newsize + 1, AUTOMATIC) ||
...
STATIC MYBOOL
inc_row_space(lprec * lp, int deltarows)
{
  ...
  if (lp->rows + deltarows > lp->rows_alloc)
  {
    ...
    if (!allocREAL(lp, &lp->orig_rhs, rowsum, AUTOMATIC) || !allocLREAL(lp, &lp->rhs, rowsum, AUTOMATIC) ||
        !allocINT(lp, &lp->row_type, rowsum, AUTOMATIC) || !allocINT(lp, &lp->var_basic, rowsum, AUTOMATIC))
      return (FALSE);
...
STATIC MYBOOL
inc_col_space(lprec * lp, int deltacols)
{
  ...
  if (lp->columns + deltacols >= lp->columns_alloc)
  {
    ...
    if (!allocREAL(lp, &lp->orig_obj, colsum, AUTOMATIC) || !allocMYBOOL(lp, &lp->var_type, colsum, AUTOMATIC) ||
...
MYBOOL __WINAPI
set_obj(lprec * lp, int colnr, REAL value)
{
  if (colnr <= 0)
...
MYBOOL __WINAPI
set_obj_fnex(lprec * lp, int count, REAL * row, int * colno)
{
...
MYBOOL __WINAPI
set_obj_fn(lprec * lp, REAL * row)
{
  return (set_obj_fnex(lp, 0, row, NULL));
}

MYBOOL __WINAPI
str_set_obj_fn(lprec * lp, const char * row_string)
{
  int          i;
  MYBOOL       ret = TRUE;
  REAL *       arow;
...
STATIC MYBOOL
append_columns(lprec * lp, int deltacolumns)
{
...
STATIC MYBOOL
append_rows(lprec * lp, int deltarows)
{
...
MYBOOL __WINAPI
set_add_rowmode(lprec * lp, MYBOOL turnon)
{
...
MYBOOL __WINAPI
is_add_rowmode(lprec * lp)
{
  return (lp->matA->is_roworder);
}

MYBOOL __WINAPI
set_row(lprec * lp, int rownr, REAL * row)
{
  if ((rownr < 0) || (rownr > lp->rows))
  {
...
MYBOOL __WINAPI
set_rowex(lprec * lp, int rownr, int count, REAL * row, int * colno)
{
  if ((rownr < 0) || (rownr > lp->rows))
  {
...
MYBOOL __WINAPI
str_add_constraint(lprec * lp, const char * row_string, int constr_type, REAL rh)
{
  int          i;
  const char * p;
  char *       newp;
...
STATIC MYBOOL
del_constraintex(lprec * lp, LLrec * rowmap)
{
  int i;
...
MYBOOL __WINAPI
del_constraint(lprec * lp, int rownr)
{
...
MYBOOL __WINAPI
add_lag_con(lprec * lp, REAL * row, int con_type, REAL rhs)
{
  int  k;
  REAL sign;
...
MYBOOL __WINAPI
str_add_lag_con(lprec * lp, const char * row_string, int con_type, REAL rhs)
{
  int          i;
  MYBOOL       ret = TRUE;
  REAL *       a_row;
...
/* INLINE */ MYBOOL
is_splitvar(lprec * lp, int colnr)
...
*/
{
  return ((MYBOOL)((lp->var_is_free != NULL) && (lp->var_is_free[colnr] < 0) && (-lp->var_is_free[colnr] != colnr)));
}

void
del_splitvars(lprec * lp)
{
  int j, jj, i;
...
MYBOOL __WINAPI
set_column(lprec * lp, int colnr, REAL * column)
{
  return (mat_setcol(lp->matA, colnr, lp->rows, column, NULL, TRUE, TRUE));
}

MYBOOL __WINAPI
set_columnex(lprec * lp, int colnr, int count, REAL * column, int * rowno)
{
  return (mat_setcol(lp->matA, colnr, count, column, rowno, TRUE, TRUE));
}

MYBOOL __WINAPI
add_columnex(lprec * lp, int count, REAL * column, int * rowno)
       ...
       a bound, but this currently is not the case  */
{
    ...
    if (lp->columns != (lp->matA->is_roworder ? lp->matA->rows : lp->matA->columns))
  {
    report(lp,
           SEVERE,
           "add_columnex: Column count mismatch %d vs %d\n",
           lp->columns,
           (lp->matA->is_roworder ? lp->matA->rows : lp->matA->columns));
  }
...
MYBOOL __WINAPI
str_add_column(lprec * lp, const char * col_string)
{
  int          i;
  MYBOOL       ret = TRUE;
  REAL *       aCol;
...
STATIC MYBOOL
del_varnameex(lprec * lp, hashelem ** namelist, int items, hashtable * ht, int varnr, LLrec * varmap)
{
  (void)lp;
  int i, n;
  (void)lp;
...
STATIC MYBOOL
del_columnex(lprec * lp, LLrec * colmap)
{
...
void __WINAPI
set_simplextype(lprec * lp, int simplextype)
{
  lp->simplex_strategy = simplextype;
}

int __WINAPI
get_simplextype(lprec * lp)
{
  return (lp->simplex_strategy);
}

void __WINAPI
set_preferdual(lprec * lp, MYBOOL dodual)
{
  if (dodual & TRUE)
...
void __WINAPI
set_bounds_tighter(lprec * lp, MYBOOL tighten)
{
  lp->tighten_on_set = tighten;
}
MYBOOL __WINAPI
get_bounds_tighter(lprec * lp)
{
  return (lp->tighten_on_set);
}

MYBOOL __WINAPI
set_upbo(lprec * lp, int colnr, REAL value)
{
  if ((colnr > lp->columns) || (colnr < 1))
  {
  ...
  else
  {
    ...
    if (value > lp->infinite)
      value = lp->infinite;
    if (value < lp->infinite && lp->orig_lowbo[lp->rows + colnr] > -lp->infinite &&
        value != lp->orig_lowbo[lp->rows + colnr] && fabs(value - lp->orig_lowbo[lp->rows + colnr]) < lp->epsvalue)
...
MYBOOL __WINAPI
set_lowbo(lprec * lp, int colnr, REAL value)
{
  if ((colnr > lp->columns) || (colnr < 1))
  {
  ...
  else
  {
    ...
    if (value < -lp->infinite)
      value = -lp->infinite;
    if (value > -lp->infinite && lp->orig_upbo[lp->rows + colnr] < lp->infinite &&
        value != lp->orig_upbo[lp->rows + colnr] && fabs(value - lp->orig_upbo[lp->rows + colnr]) < lp->epsvalue)
      value = lp->orig_upbo[lp->rows + colnr];
    lp->orig_lowbo[lp->rows + colnr] = value;
  }
  return (TRUE);
...
MYBOOL __WINAPI
set_bounds(lprec * lp, int colnr, REAL lower, REAL upper)
{
  if ((colnr > lp->columns) || (colnr < 1))
  {
...
MYBOOL
get_bounds(lprec * lp, int column, REAL * lower, REAL * upper)
{
...
MYBOOL __WINAPI
set_int(lprec * lp, int colnr, MYBOOL var_type)
{
  if ((colnr > lp->columns) || (colnr < 1))
  {
...
int __WINAPI
add_SOS(lprec * lp, const char * name, int sostype, int priority, int count, int * sosvars, REAL * weights)
{
  SOSrec * SOS;
  int      k;
...
STATIC int
add_GUB(lprec * lp, const char * name, int priority, int count, int * gubvars)
{
  SOSrec * GUB;
  int      k;
...
MYBOOL __WINAPI
set_binary(lprec * lp, int colnr, MYBOOL must_be_bin)
{
  MYBOOL status = FALSE;
...
is_binary(lprec * lp, int colnr)
{
  ...
  return ((MYBOOL)(((lp->var_type[colnr] & ISINTEGER) != 0) && (get_lowbo(lp, colnr) == 0) &&
                   (fabs(get_upbo(lp, colnr) - 1) < lp->epsprimal)));
}

MYBOOL __WINAPI
set_unbounded(lprec * lp, int colnr)
{
  if ((colnr > lp->columns) || (colnr < 1))
  {
...
MYBOOL __WINAPI
is_unbounded(lprec * lp, int colnr)
{
  MYBOOL test;
  ...
  {
    colnr += lp->rows;
    test = (MYBOOL)((lp->orig_lowbo[colnr] <= -lp->infinite) && (lp->orig_upbo[colnr] >= lp->infinite));
  }
  return (test);
}

MYBOOL __WINAPI
is_negative(lprec * lp, int colnr)
{
  if ((colnr > lp->columns) || (colnr < 1))
  {
  ...
  colnr += lp->rows;
  return ((MYBOOL)((lp->orig_upbo[colnr] <= 0) && (lp->orig_lowbo[colnr] < 0)));
}

MYBOOL __WINAPI
set_var_weights(lprec * lp, REAL * weights)
{
  if (lp->var_priority != NULL)
  {
...
MYBOOL __WINAPI
set_var_priority(lprec * lp)
/* Experimental automatic variable ordering/priority setting */
{
  MYBOOL status = FALSE;

  if (is_bb_mode(lp, NODE_AUTOORDER) && (lp->var_priority == NULL) && (SOS_count(lp) == 0))
  {
...
int __WINAPI
get_var_priority(lprec * lp, int colnr)
{
  if ((colnr > lp->columns) || (colnr < 1))
  {
...
MYBOOL __WINAPI
set_semicont(lprec * lp, int colnr, MYBOOL must_be_sc)
{
  if ((colnr > lp->columns) || (colnr < 1))
  {
...
MYBOOL __WINAPI
is_semicont(lprec * lp, int colnr)
{
  if ((colnr > lp->columns) || (colnr < 1))
  {
...
MYBOOL __WINAPI
set_rh(lprec * lp, int rownr, REAL value)
{
...
REAL
get_rh_upper(lprec * lp, int rownr)
{
  REAL value, valueR;
...
REAL
get_rh_lower(lprec * lp, int rownr)
{
  REAL value, valueR;
...
MYBOOL
set_rh_upper(lprec * lp, int rownr, REAL value)
{
...
MYBOOL
set_rh_lower(lprec * lp, int rownr, REAL value)
{
  if (rownr > lp->rows || rownr < 1)
  {
...
MYBOOL __WINAPI
set_rh_range(lprec * lp, int rownr, REAL deltavalue)
{
  if ((rownr > lp->rows) || (rownr < 1))
  {
...
REAL __WINAPI
get_rh_range(lprec * lp, int rownr)
{
  if ((rownr > lp->rows) || (rownr < 0))
  {
...
MYBOOL __WINAPI
str_set_rh_vec(lprec * lp, const char * rh_string)
{
  int          i;
  MYBOOL       ret = TRUE;
  REAL *       newrh;
...
void __WINAPI
set_sense(lprec * lp, MYBOOL maximize)
{
...
is_maxim(lprec * lp)
{
  return ((MYBOOL)((lp->row_type != NULL) && ((lp->row_type[0] & ROWTYPE_CHSIGN) == ROWTYPE_GE)));
}

MYBOOL __WINAPI
set_constr_type(lprec * lp, int rownr, int con_type)
{
  MYBOOL oldchsign;
...
/* INLINE */ MYBOOL
is_chsign(lprec * lp, int rownr) { return ((MYBOOL)((lp->row_type[rownr] & ROWTYPE_CONSTRAINT) == ROWTYPE_CHSIGN)); }

MYBOOL __WINAPI
is_constr_type(lprec * lp, int rownr, int mask)
{
  if ((rownr < 0) || (rownr > lp->rows))
  {
...
int __WINAPI
get_constr_type(lprec * lp, int rownr)
{
  if ((rownr < 0) || (rownr > lp->rows))
  {
...
REAL __WINAPI
get_constr_value(lprec * lp, int rownr, int count, REAL * primsolution, int * nzindex)
{
  int      i;
  REAL     value = 0.0;
  MATrec * mat = lp->matA;
  ...
  if (!mat_validate(mat) || ((primsolution == NULL) && (lp->solvecount == 0)))
    return (value);
  i = get_Ncolumns(lp);
  if ((primsolution != NULL) && (nzindex == NULL) && ((count <= 0) || (count > i)))
    count = i;
...
STATIC const char *
get_str_constr_class(lprec * lp, int con_class)
{
  (void)lp;
  switch (con_class)
  {
    case ROWCLASS_Unknown:
      return ("Unknown");
    case ROWCLASS_Objective:
      return ("Objective");
    case ROWCLASS_GeneralREAL:
      return ("General REAL");
    case ROWCLASS_GeneralMIP:
      return ("General MIP");
    case ROWCLASS_GeneralINT:
      return ("General INT");
    case ROWCLASS_GeneralBIN:
      return ("General BIN");
    case ROWCLASS_KnapsackINT:
      return ("Knapsack INT");
    case ROWCLASS_KnapsackBIN:
      return ("Knapsack BIN");
    case ROWCLASS_SetPacking:
      return ("Set packing");
    case ROWCLASS_SetCover:
      return ("Set cover");
    case ROWCLASS_GUB:
      return ("GUB");
    default:
...
STATIC const char *
get_str_constr_type(lprec * lp, int con_type)
{
  (void)lp;
  switch (con_type)
  {
...
STATIC int
get_constr_class(lprec * lp, int rownr)
{
  int      aBIN = 0, aINT = 0, aREAL = 0, xBIN = 0, xINT = 0, xREAL = 0;
...
REAL __WINAPI
get_mat(lprec * lp, int rownr, int colnr)
{
  REAL value;
  int  elmnr;
...
REAL __WINAPI
get_mat_byindex(lprec * lp, int matindex, MYBOOL isrow, MYBOOL adjustsign)
...
static int
mat_getrow(lprec * lp, int rownr, REAL * row, int * colno)
{
  MYBOOL isnz;
  int    j, countnz = 0;
  REAL   a;
...
static int
mat_getcolumn(lprec * lp, int colnr, REAL * column, int * nzrow)
{
...
int __WINAPI
get_columnex(lprec * lp, int colnr, REAL * column, int * nzrow)
{
  if ((colnr > lp->columns) || (colnr < 1))
  {
...
MYBOOL __WINAPI
get_column(lprec * lp, int colnr, REAL * column)
{
  return ((MYBOOL)(get_columnex(lp, colnr, column, NULL) >= 0));
}

int __WINAPI
get_rowex(lprec * lp, int rownr, REAL * row, int * colno)
{
  if ((rownr < 0) || (rownr > lp->rows))
  {
...
MYBOOL __WINAPI
get_row(lprec * lp, int rownr, REAL * row)
{
  return ((MYBOOL)(get_rowex(lp, rownr, row, NULL) >= 0));
}

STATIC void
set_OF_override(lprec * lp, REAL * ofVector)
...
MYBOOL
modifyOF1(lprec * lp, int index, REAL * ofValue, REAL mult)
...
STATIC void
set_OF_p1extra(lprec * lp, REAL p1extra)
{
  int    i;
  REAL * value;
  ...
  if (lp->spx_trace)
    report(lp,
           DETAILED,
           "set_OF_p1extra: Set dual objective offset to %g at iter %.0f.\n",
           p1extra,
...
REAL __WINAPI
get_OF_active(lprec * lp, int varnr, REAL mult)
{
...
STATIC MYBOOL
is_OF_nz(lprec * lp, int colnr)
{
  return ((MYBOOL)(lp->orig_obj[colnr] != 0));
}

STATIC int
singleton_column(lprec * lp, int row_nr, REAL * column, int * nzlist, REAL value, int * maxabs)
{
  int nz = 1;
...
STATIC int
expand_column(lprec * lp, int col_nr, REAL * column, int * nzlist, REAL mult, int * maxabs)
{
  ...
  if (nzlist == NULL)
  {
    ...
    nzcount = i;
    for (; i < ie; i++, matRownr += matRowColStep, matValue += matValueStep)
    {
      j = *matRownr;
      value = *matValue;
      if (j > 0)
...
int __WINAPI
obtain_column(lprec * lp, int varin, REAL * pcol, int * nzlist, int * maxabs)
{
...
MYBOOL __WINAPI
set_BFP(lprec * lp, const char * filename)
...
#  endif
    ...
    if ((result != LIB_LOADED) ||
        ((lp->bfp_name == NULL) || (lp->bfp_compatible == NULL) || (lp->bfp_free == NULL) || (lp->bfp_resize == NULL) ||
         (lp->bfp_nonzeros == NULL) || (lp->bfp_memallocated == NULL) || (lp->bfp_restart == NULL) ||
         (lp->bfp_mustrefactorize == NULL) || (lp->bfp_preparefactorization == NULL) || (lp->bfp_factorize == NULL) ||
         (lp->bfp_finishupdate == NULL) || (lp->bfp_ftran_normal == NULL) || (lp->bfp_ftran_prepare == NULL) ||
         (lp->bfp_btran_normal == NULL) || (lp->bfp_status == NULL) || (lp->bfp_implicitslack == NULL) ||
         (lp->bfp_indexbase == NULL) || (lp->bfp_rowoffset == NULL) || (lp->bfp_pivotmax == NULL) ||
         (lp->bfp_init == NULL) || (lp->bfp_pivotalloc == NULL) || (lp->bfp_colcount == NULL) ||
         (lp->bfp_canresetbasis == NULL) || (lp->bfp_finishfactorization == NULL) ||
         (lp->bfp_updaterefactstats == NULL) || (lp->bfp_prepareupdate == NULL) || (lp->bfp_pivotRHS == NULL) ||
         (lp->bfp_btran_double == NULL) || (lp->bfp_efficiency == NULL) || (lp->bfp_pivotvector == NULL) ||
         (lp->bfp_pivotcount == NULL) || (lp->bfp_refactcount == NULL) || (lp->bfp_isSetI == NULL) ||
  ...
  if (filename != NULL)
  {
    ...
    {
      case LIB_NOTFOUND:
        strcpy(info, LIB_STR_NOTFOUND);
        break;
      case LIB_NOINFO:
        strcpy(info, LIB_STR_NOINFO);
        break;
      case LIB_NOFUNCTION:
        strcpy(info, LIB_STR_NOFUNCTION);
        break;
      case LIB_VERINVALID:
        strcpy(info, LIB_STR_VERINVALID);
        break;
      default:
        strcpy(info, LIB_STR_LOADED);
    }
...
/* DON'T MODIFY */
lprec * __WINAPI
read_XLI(char * xliname, const char * modelname, const char * dataname, const char * options, int verbose)
{
  lprec * lp;
...
MYBOOL __WINAPI
write_XLI(lprec * lp, const char * filename, const char * options, MYBOOL results)
{
...
MYBOOL __WINAPI
set_XLI(lprec * lp, const char * filename)
...
#endif
    /* Do validation */
    if ((result != LIB_LOADED) || ((lp->xli_name == NULL) || (lp->xli_compatible == NULL) ||
                                   (lp->xli_readmodel == NULL) || (lp->xli_writemodel == NULL)))
    {
      set_XLI(lp, NULL);
      if (result == LIB_LOADED)
        result = LIB_NOFUNCTION;
...
STATIC int
get_basisOF(lprec * lp, int coltarget[], REAL crow[], int colno[])
   ...
   is filled with the count of non-zero values and the index to those. */
{
  ...
  else
  {
    ...
    for (i = 1, crow++, basvar++; i <= n; i++, crow++, basvar++)
    {
...
int __WINAPI
get_basiscolumn(lprec * lp, int j, int rn[], double bj[])
...
{
  int k = lp->bfp_rowoffset(lp), matbase = lp->bfp_indexbase(lp);
...
MYBOOL __WINAPI
get_primal_solution(lprec * lp, REAL * pv)
{
  if (lp->spx_status == OPTIMAL)
    ;
  else if (!lp->basis_valid)
...
MYBOOL __WINAPI
get_ptr_primal_solution(lprec * lp, REAL ** pv)
{
  *pv = lp->best_solution;
  return (TRUE);
}
...
MYBOOL __WINAPI
get_dual_solution(lprec * lp, REAL * rc)
{
  REAL * duals;
  MYBOOL ret;
...
MYBOOL __WINAPI
get_ptr_dual_solution(lprec * lp, REAL ** rc)
{
...
MYBOOL __WINAPI
get_lambda(lprec * lp, REAL * lambda)
{
...
MYBOOL __WINAPI
get_ptr_lambda(lprec * lp, REAL ** lambda)
{
  *lambda = lp->lambda;
  return (TRUE);
}
...
int __WINAPI
get_orig_index(lprec * lp, int lp_index)
{
  if (lp->varmap_locked)
...
int __WINAPI
get_lp_index(lprec * lp, int orig_index)
{
  if (lp->varmap_locked)
...
MYBOOL __WINAPI
is_feasible(lprec * lp, REAL * values, REAL threshold)
...
int __WINAPI
column_in_lp(lprec * lp, REAL * testcolumn)
{
  int      i, j, je, colnr = 0;
  int      nz, ident = 1;
  MATrec * mat = lp->matA;
  ...
  for (nz = 0, i = 1; i <= lp->rows; i++)
    if (fabs(testcolumn[i]) > lp->epsvalue)
      nz++;
  ...
  for (i = 1; (i <= lp->columns) && (ident); i++)
  {
    ...
    for (; (j < je) && (ident >= 0); j++, ident--, matRownr += matRowColStep, matValue += matValueStep)
    {
      value = *matValue;
...
MYBOOL __WINAPI
set_lp_name(lprec * lp, const char * name)
{
  if (name == NULL)
  {
    FREE(lp->lp_name);
...
const char * __WINAPI
get_lp_name(lprec * lp)
{
  return ((lp->lp_name != NULL) ? lp->lp_name : (char *)"");
}

STATIC MYBOOL
init_rowcol_names(lprec * lp)
{
  if (!lp->names_used)
  {
...
MYBOOL
rename_var(lprec * lp, int varindex, const char * new_name, hashelem ** list, hashtable ** ht)
{
  hashelem * hp;
  MYBOOL     newitem;
  ...
  else if ((strlen(hp->name) != strlen(new_name)) || (strcmp(hp->name, new_name) != 0))
  {
...
MYBOOL __WINAPI
is_use_names(lprec * lp, MYBOOL isrow)
{
  if (isrow)
...
void __WINAPI
set_use_names(lprec * lp, MYBOOL isrow, MYBOOL use_names)
{
  if (isrow)
...
int __WINAPI
get_nameindex(lprec * lp, const char * varname, MYBOOL isrow)
{
  if (isrow)
...
MYBOOL __WINAPI
set_row_name(lprec * lp, int rownr, const char * new_name)
{
...
const char * __WINAPI
get_row_name(lprec * lp, int rownr)
{
  if ((rownr < 0) || (rownr > lp->rows + 1))
  {
...
const char * __WINAPI
get_origrow_name(lprec * lp, int rownr)
{
  MYBOOL newrow;
  char * ptr;
...
MYBOOL __WINAPI
set_col_name(lprec * lp, int colnr, const char * new_name)
{
...
const char * __WINAPI
get_col_name(lprec * lp, int colnr)
{
  if ((colnr > lp->columns + 1) || (colnr < 1))
  {
...
const char * __WINAPI
get_origcol_name(lprec * lp, int colnr)
{
  MYBOOL newcol;
  char * ptr;
...
STATIC int
bin_count(lprec * lp, MYBOOL working)
{
  int i, n = 0;
  if (working)
  {
  ...
  {
    for (i = 1; i <= lp->columns; i++)
      if ((fabs(get_upbo(lp, i) - 1) < lp->epsvalue) && (fabs(get_lowbo(lp, i) - 0) < lp->epsvalue))
        n++;
  }
  return (n);
}
...
STATIC REAL
compute_violation(lprec * lp, int row_nr)
...
STATIC REAL
feasibilityOffset(lprec * lp, MYBOOL isdual)
{
  int  i, j;
  REAL f, Extra;
...
STATIC REAL
compute_dualslacks(lprec * lp, int target, REAL ** dvalues, int ** nzdvalues, MYBOOL dosum)
/* Note that this function is similar to the compute_reducedcosts function in lp_price.c */
{
  int    i, varnr, *coltarget, **nzduals, *nzvtemp = NULL;
  REAL   d, g = 0, **duals, *vtemp = NULL;
  MYBOOL localREAL = (MYBOOL)(dvalues == NULL), localINT = (MYBOOL)(nzdvalues == NULL);
...
#  pragma clang diagnostic pop
  ...
  prod_xA(lp, coltarget, *duals, NULL, lp->epsmachine, 1.0, *duals, *nzduals, MAT_ROUNDDEFAULT | MAT_ROUNDRC);
  mempool_releaseVector(lp->workarrays, (char *)coltarget, FALSE);
...
STATIC REAL
compute_feasibilitygap(lprec * lp, MYBOOL isdual, MYBOOL dosum)
{
  REAL f = 0;
...
STATIC int
row_decimals(lprec * lp, int rownr, MYBOOL intsonly, REAL * intscalar)
{
...
{
  MYBOOL   OFgcd;
  int      colnr, rownr, n, ib, ie, pluscount, intcount;
  int      intval, maxndec;
...
STATIC REAL
row_plusdelta(lprec * lp, int rownr, int excludecol, int * intcount, int * realcount)
{
  MATrec * mat = lp->matA;
  int      j, jb, je, jj, bincount, n = 0, nrows = lp->rows;
  REAL     rowval, deltaOF = 0, *obj_orig = lp->orig_obj, *obj_sort = NULL;
  ...
  *intcount = 0;
  ...
  for (j = jb; j < je; j++)
  {
    ...
    if (is_int(lp, jj))
    {
      ...
      if ((rowval < lp->infinite) && (fabs(unscaled_value(lp, rowval - lp->orig_lowbo[nrows + jj], nrows + jj) - 1) <
                                      lp->epsint)) // difference between upper and lower = 1 is ok
        bincount++;
      if (rownr == 0)
   ...
   looking for a single solution, not possibly several equal-valued ones). */
{
  ...
  if ((lp->int_vars > 0) && (lp->solutionlimit == 1) && mat_validate(mat))
  {
    ...
    int colnr, ib, ie, intcount, realcount;
...
STATIC MYBOOL
isPrimalSimplex(lprec * lp)
{
  return (
    (MYBOOL)(((lp->simplex_mode & SIMPLEX_Phase1_PRIMAL) != 0) || ((lp->simplex_mode & SIMPLEX_Phase2_PRIMAL) != 0)));
}
...
{
  return (
    (MYBOOL)(((lp->simplex_mode & SIMPLEX_Phase1_PRIMAL) != 0) || ((lp->simplex_mode & SIMPLEX_Phase1_DUAL) != 0)));
}
...
STATIC MYBOOL
feasiblePhase1(lprec * lp, REAL epsvalue)
{
  REAL   gap;
  MYBOOL test;
...
STATIC MYBOOL
isDegenerateBasis(lprec * lp, int basisvar)
{
  int varindex;

  varindex = lp->var_basic[basisvar];
  if ((fabs(lp->rhs[basisvar]) < lp->epsprimal) || (fabs(lp->upbo[varindex] - lp->rhs[basisvar]) < lp->epsprimal))
    return (TRUE);
  else
    return (FALSE);
}
...
STATIC int
findBasicFixedvar(lprec * lp, int afternr, MYBOOL slacksonly)
{
  int varnr, delta = 1;
...
STATIC MYBOOL
isBasisVarFeasible(lprec * lp, REAL tol, int basis_row)
{
  int    col;
  REAL   x;
  MYBOOL Ok = TRUE;
...
STATIC MYBOOL
isPrimalFeasible(lprec * lp, REAL tol, int infeasibles[], REAL * feasibilitygap)
{
  int    i;
  ...
  if (infeasibles != NULL)
    infeasibles[0] = 0;
  for (i = 1, rhsptr = lp->rhs + 1, idxptr = lp->var_basic + 1; (i <= lp->rows); i++, rhsptr++, idxptr++)
  {
    feasible = TRUE;
...
STATIC MYBOOL
isDualFeasible(lprec * lp, REAL tol, int * boundflipcount, int infeasibles[], REAL * feasibilitygap)
{
  int i, varnr, n = 0, /* Number of infeasible duals corrected with bound-swaps */
    m = 0, target = SCAN_ALLVARS + USE_NONBASICVARS;
  REAL   f = 0;
  ...
  if ((infeasibles != NULL) || (boundflipcount != NULL))
  {
    ...
    if (nzdcol != NULL)
      for (i = 1; i <= nzdcol[0]; i++)
      {
        ...
        if ((boundflipcount == NULL) || ((lp->bb_level <= 1) && (my_rangebo(lp, varnr) > fabs(lp->negrange))) ||
            (islower && my_infinite(lp, lp->upbo[varnr])) || (!islower && my_infinite(lp, my_lowbo(lp, varnr))))
        {
          m++;
          if (infeasibles != NULL)
            infeasibles[m] = varnr;
...
int __WINAPI
get_basiscrash(lprec * lp)
{
  return (lp->crashmode);
}

void __WINAPI
set_basiscrash(lprec * lp, int mode)
{
  lp->crashmode = mode;
}

MYBOOL __WINAPI
set_basis(lprec * lp, int * bascolumn, MYBOOL nonbasic) /* Added by KE */
{
  int i, s, k, n;

  /* Make sure we are consistent */
  if (lp->wasPresolved &&
      ((lp->rows != lp->presolve_undo->orig_rows) || (lp->columns != lp->presolve_undo->orig_columns)))
    return (FALSE);
...
MYBOOL __WINAPI
get_basis(lprec * lp, int * bascolumn, MYBOOL nonbasic)
{
  int k, i;

  if (!lp->basis_valid || (lp->rows != lp->presolve_undo->orig_rows) ||
...
STATIC MYBOOL
is_BasisReady(lprec * lp)
{
  return ((MYBOOL)(lp->var_basic[0] != AUTOMATIC));
}

STATIC MYBOOL
is_slackbasis(lprec * lp)
{
  int n = 0, err = 0;
  if (lp->basis_valid)
  {
...
int __WINAPI
set_basisvar(lprec * lp, int basisPos, int enteringCol)
{
  int leavingCol;
  ...
  if ((basisPos < 1) || (basisPos > lp->rows))
    report(lp,
           SEVERE,
           "set_basisvar: Invalid leaving basis position %d specified at iter %.0f\n",
           basisPos,
           (double)get_total_iter(lp));
  if ((leavingCol < 1) || (leavingCol > lp->sum))
    report(lp,
           SEVERE,
           "set_basisvar: Invalid leaving column %d referenced at iter %.0f\n",
           leavingCol,
           (double)get_total_iter(lp));
  if ((enteringCol < 1) || (enteringCol > lp->sum))
    report(lp,
           SEVERE,
           "set_basisvar: Invalid entering column %d specified at iter %.0f\n",
           enteringCol,
           (double)get_total_iter(lp));
#endif
  ...
  if (!lp->is_basic[leavingCol])
    report(lp,
           IMPORTANT,
           "set_basisvar: Leaving variable %d is not basic at iter %.0f\n",
           leavingCol,
           (double)get_total_iter(lp));
  if (enteringCol > lp->rows && lp->is_basic[enteringCol])
    report(lp,
           IMPORTANT,
           "set_basisvar: Entering variable %d is already basic at iter %.0f\n",
           enteringCol,
           (double)get_total_iter(lp));
#endif
...
STATIC int
perturb_bounds(lprec * lp, BBrec * perturbed, MYBOOL doRows, MYBOOL doCols, MYBOOL includeFIXED)
{
  int  i, ii, n = 0;
...
STATIC MYBOOL
impose_bounds(lprec * lp, REAL * upbo, REAL * lowbo)
...
STATIC MYBOOL
validate_bounds(lprec * lp, REAL * upbo, REAL * lowbo)
...
STATIC basisrec *
push_basis(lprec * lp, int * basisvar, MYBOOL * isbasic, MYBOOL * islower)
...
STATIC MYBOOL
pop_basis(lprec * lp, MYBOOL restore)
...
STATIC int
unload_basis(lprec * lp, MYBOOL restorelast)
{
  int levelsunloaded = 0;
...
STATIC REAL
scaled_floor(lprec * lp, int colnr, REAL value, REAL epsscale)
{
  value = floor(value);
  if (value != 0)
    if (lp->columns_scaled && is_integerscaling(lp))
...
STATIC REAL
scaled_ceil(lprec * lp, int colnr, REAL value, REAL epsscale)
{
  value = ceil(value);
  if (value != 0)
    if (lp->columns_scaled && is_integerscaling(lp))
...
STATIC MYBOOL
is_sc_violated(lprec * lp, int column)
{
  int  varno;
  REAL tmpreal;
...
STATIC int
find_sc_bbvar(lprec * lp, int * count)
{
  int    i, ii, n, bestvar;
  int    firstsc, lastsc;
  REAL   hold, holdINT, bestval, OFval, randval, scval;
  MYBOOL reversemode, greedymode, randomizemode, pseudocostmode, pseudocostsel;
  ...
  pseudocostsel = is_bb_rule(lp, NODE_PSEUDOCOSTSELECT) || is_bb_rule(lp, NODE_PSEUDONONINTSELECT) ||
  ...
  for (n = 1; n <= lp->columns; n++)
  {
    ...
    if (!lp->bb_varactive[ii] && is_sc_violated(lp, ii) && !SOS_is_marked(lp->SOS, 0, ii))
    {
      ...
      if (hold > bestval)
      {
        if ((bestvar == 0) || (hold > bestval + lp->epsprimal) ||
            (fabs(modf(lp->solution[i] / scval, &holdINT) - 0.5) <
             fabs(
               modf(lp->solution[bestvar] / get_pseudorange(lp->bb_PseudoCost, bestvar - lp->rows, BB_SC), &holdINT) -
               0.5)))
        {
          bestval = hold;
          bestvar = i;
...
STATIC int
find_sos_bbvar(lprec * lp, int * count, MYBOOL intsos)
{
  int k, i, j, var;
...
STATIC int
find_int_bbvar(lprec * lp, int * count, BBrec * BB, MYBOOL * isfeasible)
{
  int    i, ii, n, k, bestvar, depthmax, *nonint = NULL;
  REAL   hold, holdINT, bestval, OFval, randval, *lowbo = BB->lowbo, *upbo = BB->upbo;
  MYBOOL reversemode, greedymode, depthfirstmode, breadthfirstmode, randomizemode, rcostmode, pseudocostmode,
    pseudocostsel, pseudostrong, isINT, valINT;
  ...
  breadthfirstmode = is_bb_mode(lp, NODE_BREADTHFIRSTMODE) && (MYBOOL)(lp->bb_level <= lp->int_vars);
  rcostmode = (MYBOOL) /* FALSE */ (BB->lp->solutioncount > 0) && is_bb_mode(lp, NODE_RCOSTFIXING);
  /* 5/2/08 peno disabled NODE_RCOSTFIXING because it results in non-optimal solutions with some models */ /* 15/2/8
                                                                                                              peno
                                                                                                              enabled
                                                                                                              NODE_RCOSTFIXING
                                                                                                              again
  ...
  pseudocostsel = is_bb_rule(lp, NODE_PSEUDOCOSTSELECT) || is_bb_rule(lp, NODE_PSEUDONONINTSELECT) ||
                  is_bb_rule(lp, NODE_PSEUDORATIOSELECT);
  pseudostrong = FALSE && pseudocostsel && !rcostmode && is_bb_mode(lp, NODE_STRONGINIT);
  ...
  *count = n;
  ...
  if (is_bb_rule(lp, NODE_FIRSTSELECT))
  {
    ...
    for (n = 1; n <= nonint[0]; n++)
    {
      ...
      if (pseudostrong &&
          (MAX(lp->bb_PseudoCost->LOcost[ii].rownr, lp->bb_PseudoCost->UPcost[ii].rownr) <
           lp->bb_PseudoCost->updatelimit) &&
          (MAX(lp->bb_PseudoCost->LOcost[ii].colnr, lp->bb_PseudoCost->UPcost[ii].colnr) <
           5 * lp->bb_PseudoCost->updatelimit))
      {
      ...
      if (hold > bestval)
      {
        if ((hold > bestval + lp->epsprimal) ||
            (fabs(modf(lp->solution[i], &holdINT) - 0.5) < fabs(modf(lp->solution[bestvar], &holdINT) - 0.5)))
        {
          bestval = hold;
          bestvar = i;
        }
...
STATIC BBPSrec *
init_pseudocost(lprec * lp, int pseudotype)
{
  int       i;
...
STATIC MYBOOL
free_pseudoclass(BBPSrec ** PseudoClass)
{
...
MYBOOL __WINAPI
set_pseudocosts(lprec * lp, REAL * clower, REAL * cupper, int * updatelimit)
{
  int i;
...
MYBOOL __WINAPI
get_pseudocosts(lprec * lp, REAL * clower, REAL * cupper, int * updatelimit)
{
  int i;
...
STATIC REAL
get_pseudorange(BBPSrec * pc, int mipvar, int varcode)
{
  if (varcode == BB_SC)
...
STATIC void
update_pseudocost(BBPSrec * pc, int mipvar, int varcode, MYBOOL capupper, REAL varsol)
{
  REAL      OFsol, uplim;
  MATitem * PS;
  ...
  if (((mipvar <= 0) || (PS->rownr < mipvar)) && (fabs(varsol) > pc->lp->epspivot))
  {
...
STATIC REAL
get_pseudobranchcost(BBPSrec * pc, int mipvar, MYBOOL dofloor)
{
  if (dofloor)
...
STATIC REAL
get_pseudonodecost(BBPSrec * pc, int mipvar, int vartype, REAL varsol)
{
  REAL hold, uplim;
...
STATIC int
compute_theta(lprec * lp, int rownr, LREAL * theta, int isupbound, REAL HarrisScalar, MYBOOL primal)
   ...
   the leaving variable. Note that the incoming theta is "d" in Chvatal-terminology */
{
  ...
  REAL  lb = 0,                                /* Put lower bound here when the fully bounded version is implemented */
    ub = lp->upbo[colnr], eps = lp->epsprimal; /* Primal feasibility tolerance */
...
STATIC MYBOOL
check_degeneracy(lprec * lp, REAL * pcol, int * degencount)
                 ...
                 int *   boundswaps)
{
  ...
  if (!lp->is_lower[varout])
    report(lp,
           SEVERE,
           "performiteration: Leaving variable %d was at its upper bound at iter %.0f\n",
           varout,
           (double)get_total_iter(lp));
#endif
  ...
  if (enteringUB < 0)
    report(lp,
           SEVERE,
           "performiteration: Negative range for entering variable %d at iter %.0f\n",
           varin,
           (double)get_total_iter(lp));
  if (leavingUB < 0)
    report(lp,
           SEVERE,
           "performiteration: Negative range for leaving variable %d at iter %.0f\n",
           varout,
           (double)get_total_iter(lp));
#endif
...
/* #define v51mode */ /* Enable this for v5.1 operation mode */
  ...
  if ((lp->verbose > NORMAL) && (MIP_count(lp) == 0) && ((lp->current_iter % MAX(2, lp->rows / 10)) == 0))
  ...
  if (lp->spx_trace)
  {
    if (minitNow)
      report(lp,
             NORMAL,
             "I:%5.0f - minor - %5d ignored,          %5d flips  from %s with THETA=%g and OBJ=%g\n",
             (double)get_total_iter(lp),
             varout,
             varin,
             (enteringFromUB ? "UPPER" : "LOWER"),
             theta,
             lp->rhs[0]);
    else
      report(lp,
             NORMAL,
             "I:%5.0f - MAJOR - %5d leaves to %s,  %5d enters from %s with THETA=%g and OBJ=%g\n",
             (double)get_total_iter(lp),
             varout,
             (leavingToUB ? "UPPER" : "LOWER"),
             varin,
             (enteringFromUB ? "UPPER" : "LOWER"),
             theta,
             lp->rhs[0]);
    ...
    if (!primal)
    {
      ...
      report(lp,
             NORMAL,
             "performiteration: Feasibility gap at iter %.0f is " RESULTVALUEMASK "\n",
             (double)get_total_iter(lp),
             pivot);
    }
    else
...
STATIC REAL
get_refactfrequency(lprec * lp, MYBOOL final)
{
  COUNTER iters;
  int     refacts;
...
#else
MYBOOL
is_fixedvar(lprec * lp, int varnr)
{
  if (lp->bb_bounds == NULL)
  {
    if (varnr <= lp->rows)
...
STATIC MYBOOL
solution_is_int(lprec * lp, int index, MYBOOL checkfixed)
{
#if 1
...
MYBOOL __WINAPI
set_multiprice(lprec * lp, int multiblockdiv)
{
...
int __WINAPI
get_multiprice(lprec * lp, MYBOOL getabssize)
{
...
MYBOOL __WINAPI
set_partialprice(lprec * lp, int blockcount, int * blockstart, MYBOOL isrow)
{
  int           ne, i, items;
...
void __WINAPI
get_partialprice(lprec * lp, int * blockcount, int * blockstart, MYBOOL isrow)
{
  partialrec * blockdata;
...
STATIC MYBOOL
bb_better(lprec * lp, int target, int mode)
...
*/
{
  REAL   epsvalue, offset = lp->epsprimal, refvalue = lp->infinite, testvalue = lp->solution[0];
  MYBOOL ismax = is_maxim(lp), relgap = is_action(mode, OF_TEST_RELGAP), fcast = is_action(target, OF_PROJECTED),
  ...
  switch (target)
  {
    case OF_RELAXED:
      ...
      break;
    case OF_INCUMBENT:
      refvalue = lp->best_solution[0];
      break;
    case OF_WORKING:
      refvalue = my_chsign(!ismax, lp->bb_workOF /* unscaled_value(lp, lp->bb_workOF, 0) */);
      if (fcast)
    ...
    case OF_DUALLIMIT:
      ...
      break;
    default:
      report(lp, SEVERE, "bb_better: Passed invalid test target '%d'\n", target);
      return (FALSE);
  }
...
STATIC void
construct_solution(lprec * lp, REAL * target)
{
  int      i, j, basi;
...
#  endif
  ...
  for (j = 1; j <= lp->columns; j++)
  {
    ...
    if (f != 0)
    {
      ...
      rownr = &COL_MAT_ROWNR(i);
      value = &COL_MAT_VALUE(i);
      for (; i < basi; i++, rownr += matRowColStep, value += matValueStep)
  ...
  if (target == NULL)
  {
    if (is_infinite(lp, lp->real_solution))
    {
      ...
      { /* && !lp->wasPresolved uncommented by findings of William H. Patton. The code was never executed when the test
           was there. The code has effect in an integer model with all integer objective coeff. to cut-off optimization
      ...
      if ((lp->int_vars > 0) && (my_chsign(is_maxim(lp), my_reldiff(lp->best_solution[0], lp->bb_limitOF)) < -epsvalue))
      {
...
STATIC int
check_solution(lprec * lp, int lastcolumn, REAL * solution, REAL * upbo, REAL * lowbo, REAL tolerance)
{
...
#define RelativeAccuracyCheck
  ...
  if (MIP_count(lp) > 0)
    report(lp,
           ...
           my_if(lp->bb_break && !bb_better(lp, OF_DUALLIMIT, OF_TEST_BE) && bb_better(lp, OF_RELAXED, OF_TEST_NE),
                 "Subopt.",
                 "Optimal"),
           solution[0],
           (double)lp->total_iter,
           (double)lp->bb_totalnodes,
           100.0 * fabs(my_reldiff(solution[0], lp->bb_limitOF)));
  else
    report(
      lp, NORMAL, "Optimal solution  " RESULTVALUEMASK " after %10.0f iter.\n", solution[0], (double)lp->total_iter);
  ...
  for (i = 0; i < n; i++, matRownr += matRowColStep, matColnr += matRowColStep, matValue += matValueStep)
  {
    ...
    if (diff > tolerance)
    {
      if (n < errlimit)
        report(lp,
               ...
               get_row_name(lp, i),
               value,
               (is_constr_type(lp, i, EQ) ? "equality of" : "upper bound"),
               test);
      n++;
    }
    ...
    if (diff > tolerance)
    {
      if (n < errlimit)
        report(lp,
               ...
               get_row_name(lp, i),
               value,
               (is_constr_type(lp, i, EQ) ? "equality of" : "lower bound"),
               test);
      n++;
    }
  }
...
REAL __WINAPI
get_accuracy(lprec * lp)
{
  return (lp->accuracy);
}

void __WINAPI
set_break_numeric_accuracy(lprec * lp, REAL accuracy)
{
  lp->accuracy_error = accuracy;
}

REAL __WINAPI
get_break_numeric_accuracy(lprec * lp)
{
  return (lp->accuracy_error);
}

STATIC void
transfer_solution_var(lprec * lp, int uservar)
{
  if (lp->varmap_locked && (MYBOOL)((lp->do_presolve & PRESOLVE_LASTMASKMODE) != PRESOLVE_NONE))
  {
    uservar += lp->rows;
    lp->full_solution[lp->presolve_undo->orig_rows + lp->presolve_undo->var_to_orig[uservar]] =
      lp->best_solution[uservar];
  }
}
STATIC void
transfer_solution(lprec * lp, MYBOOL dofinal)
{
  int i, ii;
  ...
  if (dofinal && lp->varmap_locked && (MYBOOL)((lp->do_presolve & PRESOLVE_LASTMASKMODE) != PRESOLVE_NONE))
  {
    presolveundorec * psundo = lp->presolve_undo;
...
#  pragma clang diagnostic pop
  ...
  prod_xA(lp, coltarget, lp->duals, NULL, lp->epsmachine, 1.0, lp->duals, NULL, MAT_ROUNDDEFAULT | MAT_ROUNDRC);
  mempool_releaseVector(lp->workarrays, (char *)coltarget, FALSE);
  ...
  if (((lp->do_presolve & PRESOLVE_LASTMASKMODE) != PRESOLVE_NONE) && allocREAL(lp, &(lp->full_duals), n + 1, TRUE))
  {
...
STATIC MYBOOL
construct_sensitivity_duals(lprec * lp)
{
  int   k, varnr, ok = TRUE;
  int * workINT = NULL;
  ...
  FREE(lp->dualsfrom);
  FREE(lp->dualstill);
  if (!allocREAL(lp, &pcol, lp->rows + 1, TRUE) || !allocREAL(lp, &lp->objfromvalue, lp->columns + 1, AUTOMATIC) ||
      !allocREAL(lp, &lp->dualsfrom, lp->sum + 1, AUTOMATIC) || !allocREAL(lp, &lp->dualstill, lp->sum + 1, AUTOMATIC))
  {
    FREE(pcol);
    FREE(lp->objfromvalue);
    FREE(lp->dualsfrom);
  ...
  else
  {
    ...
    for (varnr = 1; varnr <= lp->sum; varnr++)
    {
      ...
      {
        if (!fsolve(lp, varnr, pcol, workINT, epsvalue, 1.0, FALSE))
        ...
        for (k = 1; k <= lp->rows; k++)
        {
          ...
          {
            a = lp->rhs[k] / pcol[k];
            if ((varnr > lp->rows) && (fabs(lp->solution[varnr]) <= epsvalue) && (a < objfromvalue) &&
                (a >= lp->lowbo[varnr]))
              objfromvalue = a;
...
STATIC MYBOOL
construct_sensitivity_obj(lprec * lp)
{
  int   i, l, varnr, row_nr, ok = TRUE;
  REAL *OrigObj = NULL, *drow = NULL, *prow = NULL, sign, a, min1, min2, infinite, epsvalue, from, till;

  /* objective function */
  FREE(lp->objfrom);
  FREE(lp->objtill);
  if (!allocREAL(lp, &drow, lp->sum + 1, TRUE) || !allocREAL(lp, &OrigObj, lp->columns + 1, FALSE) ||
      !allocREAL(lp, &prow, lp->sum + 1, TRUE) || !allocREAL(lp, &lp->objfrom, lp->columns + 1, AUTOMATIC) ||
...
#  pragma clang diagnostic pop
    ...
    prod_xA(lp, coltarget, drow, NULL, epsvalue, 1.0, drow, NULL, MAT_ROUNDDEFAULT | MAT_ROUNDRC);
    ...
    for (i = 1; i <= lp->columns; i++)
    {
      ...
      else
      {
        ...
        { /* safety test; should always be found ... */
          ...
          prod_xA(lp, coltarget, prow, NULL, epsvalue, 1.0, prow, NULL, MAT_ROUNDDEFAULT);
          ...
          for (l = 1; l <= lp->sum; l++) /* search for the column(s) which first results in further iterations */
            if ((!lp->is_basic[l]) && (lp->upbo[l] > 0.0) && (fabs(prow[l]) > epsvalue) &&
                (drow[l] * (lp->is_lower[l] ? -1 : 1) < epsvalue))
            {
          ...
          if (is_maxim(lp))
          {
            if (a - lp->lowbo[varnr] < epsvalue)
              from = -infinite; /* if variable is at lower bound then decrementing objective coefficient will not result
                                   in extra iterations because it would only extra decrease the value, but since it is
                                   at its lower bound ... */
            else if (((!sensrejvar) || (lp->upbo[varnr] != 0.0)) && (lp->lowbo[varnr] + lp->upbo[varnr] - a < epsvalue))
              till = infinite; /* if variable is at upper bound then incrementing objective coefficient will not result
                                  in extra iterations because it would only extra increase the value, but since it is at
                                  its upper bound ... */
          }
          else
          {
            if (a - lp->lowbo[varnr] < epsvalue)
              till = infinite; /* if variable is at lower bound then incrementing objective coefficient will not result
                                  in extra iterations because it would only extra decrease the value, but since it is at
                                  its lower bound ... */
            else if (((!sensrejvar) || (lp->upbo[varnr] != 0.0)) && (lp->lowbo[varnr] + lp->upbo[varnr] - a < epsvalue))
              from = -infinite; /* if variable is at upper bound then decrementing objective coefficient will not result
                                   in extra iterations because it would only extra increase the value, but since it is
                                   at its upper bound ... */
          }
        }
      }
...
STATIC MYBOOL
check_if_less(lprec * lp, REAL x, REAL y, int variable)
{
  if (y < x - scaled_value(lp, lp->epsint, variable))
  {
    if (lp->bb_trace)
      report(
        lp, NORMAL, "check_if_less: Invalid new bound %g should be < %g for %s\n", x, y, get_col_name(lp, variable));
    return (FALSE);
  }
  else
    return (TRUE);
...
STATIC int
findNonBasicSlack(lprec * lp, MYBOOL * is_basic)
{
  int i;
...
STATIC int
findBasisPos(lprec * lp, int notint, int * var_basic)
{
  int i;
...
STATIC void
replaceBasisVar(lprec * lp, int rownr, int var, int * var_basic, MYBOOL * is_basic)
{
  (void)lp;
  int out;
  (void)lp;
...
STATIC void
initialize_solution(lprec * lp, MYBOOL shiftbounds)
{
  ...
  if (lp->bb_bounds != NULL)
  {
    if (shiftbounds == INITSOL_SHIFTZERO)
    {
      if (lp->bb_bounds->UBzerobased)
        report(lp,
               SEVERE,
               "initialize_solution: The upper bounds are already zero-based at refactorization %d\n",
      ...
      report(lp,
             SEVERE,
             "initialize_solution: The upper bounds are not zero-based at refactorization %d\n",
             lp->bfp_refactcount(lp, BFP_STAT_REFACT_TOTAL));
  }
  ...
  for (i = 1; i <= lp->sum; i++)
  {
    ...
    if (shiftbounds == INITSOL_SHIFTZERO)
    {
      ...
      if (lp->upbo[i] < 0)
        report(lp,
               SEVERE,
               "initialize_solution: Invalid rebounding; variable %d at refact %d, iter %.0f\n",
               i,
               lp->bfp_refactcount(lp, BFP_STAT_REFACT_TOTAL),
               (double)get_total_iter(lp));
    }
...
STATIC void
recompute_solution(lprec * lp, MYBOOL shiftbounds)
{
...
STATIC int
verify_solution(lprec * lp, MYBOOL reinvert, char * info)
{
  ...
  if (n > 0)
  {
    report(lp,
           IMPORTANT,
           "verify_solution: Iter %.0f %s - %d errors; OF %g, Max @row %d %g\n",
           (double)get_total_iter(lp),
           my_if(info == NULL, "", info),
           n,
           err,
           newmap[ii],
           errmax);
...
STATIC int
identify_GUB(lprec * lp, MYBOOL mark)
{
...
prepare_GUB(lprec * lp)
{
  ...
  if ((lp->equalities == 0) || !allocINT(lp, &members, lp->columns + 1, TRUE) || !mat_validate(mat))
    return (0);
  ...
  if (lp->lag_status != RUNNING)
  {
    ...
    if (is_piv_mode(lp, PRICE_MULTIPLE) && (primal1 || primal2))
    {
      ...
      if (lp->multiblockdiv > 1)
        report(
          lp, NORMAL, "Using %d-candidate primal simplex multiple pricing block.\n", lp->columns / lp->multiblockdiv);
    }
    else
      set_multiprice(lp, 1);
    ...
    report(lp,
           NORMAL,
           "Using %s simplex for phase 1 and %s simplex for phase 2.\n",
           my_if(primal1, "PRIMAL", "DUAL"),
           my_if(primal2, "PRIMAL", "DUAL"));
    i = get_piv_rule(lp);
    if ((i == PRICER_STEEPESTEDGE) && is_piv_mode(lp, PRICE_PRIMALFALLBACK))
      report(lp,
             NORMAL,
             "The pricing strategy is set to '%s' for the dual and '%s' for the primal.\n",
             get_str_piv_rule(i),
             get_str_piv_rule(i - 1));
    else
...
#define fullybounded FALSE
    if (((hold < lp->infinite) && my_infinite(lp, lp->orig_lowbo[i])) ||
        (!fullybounded && !my_infinite(lp, lp->negrange) && (hold < -lp->negrange) &&
         (lp->orig_lowbo[i] <= lp->negrange)))
    {
    ...
    else if ((lp->orig_lowbo[i] <= lp->negrange) && (hold >= -lp->negrange))
    {
      ...
      { /* If this variable wasn't split yet ... */
        if (SOS_is_member(lp->SOS, 0, i - lp->rows))
        { /* Added */
          report(lp, IMPORTANT, "preprocess: Converted negative bound for SOS variable %d to zero", i - lp->rows);
          lp->orig_lowbo[i] = 0;
          continue;
        }
        if (new_column == NULL)
        {
          if (!allocREAL(lp, &new_column, lp->rows + 1, FALSE) || !allocINT(lp, &new_index, lp->rows + 1, FALSE))
          {
            ok = FALSE;
            break;
          }
