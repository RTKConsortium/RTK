...
#ifndef MEMCOPY
#  define MEMCOPY(nptr, optr, nr) memcpy((nptr), (optr), (size_t)((size_t)(nr) * sizeof(*(optr))))
#endif

#ifndef MEMMOVE
#  define MEMMOVE(nptr, optr, nr) memmove((nptr), (optr), (size_t)((size_t)(nr) * sizeof(*(optr))))
#endif
...
/*#define useMMX*/
#  ifdef useMMX
#    define MEMCLEAR(ptr, nr) mem_set((ptr), '\0', (size_t)((size_t)(nr) * sizeof(*(ptr))))
#  else
#    define MEMCLEAR(ptr, nr) memset((ptr), '\0', (size_t)((size_t)(nr) * sizeof(*(ptr))))
#  endif
#endif
...
#define DELTA_SIZE(newSize, oldSize) \
  ((int)((newSize) * MIN(1.33, pow(1.5, fabs((double)newSize) / ((oldSize + newSize) + 1)))))
