...
#define MALLOC(ptr, nr, type)                                                                                         \
  ((((nr) == 0) || ((ptr = (type *)malloc((size_t)((nr) * sizeof(*ptr)))) == NULL))                                   \
   ? report(                                                                                                          \
       NULL, CRITICAL, "malloc of %d bytes failed on line %d of file %s\n", (nr) * sizeof(*ptr), __LINE__, __FILE__), \
   (ptr = NULL /* (void *) 0 */)                                                                                      \
   : ptr)
...
#define CALLOC(ptr, nr, type)                                                                                         \
  ((((nr) == 0) || ((ptr = (type *)calloc((size_t)(nr), sizeof(*ptr))) == NULL))                                      \
   ? report(                                                                                                          \
       NULL, CRITICAL, "calloc of %d bytes failed on line %d of file %s\n", (nr) * sizeof(*ptr), __LINE__, __FILE__), \
   (ptr = NULL /* (void *) 0 */)                                                                                      \
   : ptr)
...
#define REALLOC(ptr, nr, type)                                                                                         \
  ((((nr) == 0) || ((ptr = (type *)realloc(ptr, (size_t)((nr) * sizeof(*ptr)))) == NULL))                              \
   ? report(                                                                                                           \
       NULL, CRITICAL, "realloc of %d bytes failed on line %d of file %s\n", (nr) * sizeof(*ptr), __LINE__, __FILE__), \
   (ptr = NULL /* (void *) 0 */)                                                                                       \
   : ptr)
