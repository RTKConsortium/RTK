...
::GetInput1()
{
  return static_cast< const TVectorImage * >
...
::GetInput2()
{
  return static_cast< const TMatrixImage * >
...
::ThreadedGenerateData(const typename TVectorImage::RegionType& outputRegionForThread, itk::ThreadIdType itkNotUsed(threadId))
#else
