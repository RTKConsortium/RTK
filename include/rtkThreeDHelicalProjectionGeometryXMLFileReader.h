...
#ifndef rtkThreeDHelicalProjectionGeometryXMLFileReader_h
#define rtkThreeDHelicalProjectionGeometryXMLFileReader_h
...
/** \class ThreeDHelicalProjectionGeometryXMLFileReader
 *
 ...
 */
class RTK_EXPORT ThreeDHelicalProjectionGeometryXMLFileReader : public itk::XMLReader<ThreeDHelicalProjectionGeometry>
{
public:
#if ITK_VERSION_MAJOR == 5 && ITK_VERSION_MINOR == 1
  ITK_DISALLOW_COPY_AND_ASSIGN(ThreeDHelicalProjectionGeometryXMLFileReader);
#else
  ITK_DISALLOW_COPY_AND_MOVE(ThreeDHelicalProjectionGeometryXMLFileReader);
#endif

  /** Standard type alias */
  using Self = ThreeDHelicalProjectionGeometryXMLFileReader;
  using Superclass = itk::XMLReader<ThreeDHelicalProjectionGeometry>;
  using Pointer = itk::SmartPointer<Self>;

  /** Convenient type alias */
  using GeometryType = ThreeDHelicalProjectionGeometry;
  ...
  itkTypeMacro(ThreeDHelicalProjectionGeometryXMLFileReader, itk::XMLFileReader);
...
protected:
  ThreeDHelicalProjectionGeometryXMLFileReader();
  ~ThreeDHelicalProjectionGeometryXMLFileReader() override = default;
...
private:
  ...
  double m_HelixPitch{ 0. };
  double m_HelixRadius{ 0. };
  ...
  /** Projection matrix */
  ThreeDHelicalProjectionGeometry::MatrixType m_Matrix;
