...
public:
   ...
   *
   * \param rayValue Reference to projection pixel value
   * \param output Reference to volume voxel value
...
private:
  ...
  TInput *                  m_ProjectionsBuffer{ nullptr };
  TOutput *                 m_VolumeBuffer{ nullptr };
};
