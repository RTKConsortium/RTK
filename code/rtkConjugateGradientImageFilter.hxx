 ...
 */
{
  ...
  typename DotProductFilterType::Pointer IterationCostsDotProductFilter = DotProductFilterType::New();

  IterationCostsAddFilter->SetInput(0, R_kPlusOne);
  IterationCostsAddFilter->SetInput(1, this->GetB());
  IterationCostsDotProductFilter->SetInput(0, X_kPlusOne);
  IterationCostsDotProductFilter->SetInput(1, IterationCostsAddFilter->GetOutput());
  IterationCostsStatisticsImageFilter->SetInput(IterationCostsDotProductFilter->GetOutput());
