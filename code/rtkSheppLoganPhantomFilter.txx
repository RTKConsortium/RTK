...
void SheppLoganPhantomFilter< TInputImage, TOutputImage >::GenerateData()
{
  ...
  rei[0]->SetSemiPrincipalAxisZ(0.92*m_PhantomScale);
  rei[0]->SetSemiPrincipalAxisY(0.90*m_PhantomScale);
  ...
  rei[1]->SetSemiPrincipalAxisZ(0.874*m_PhantomScale);
  rei[1]->SetSemiPrincipalAxisY(0.880*m_PhantomScale);
  ...
  rei[2]->SetSemiPrincipalAxisZ(0.16*m_PhantomScale);
  rei[2]->SetSemiPrincipalAxisY(0.21*m_PhantomScale);
  rei[2]->SetCenterX(-0.22*m_PhantomScale + m_PhantomOriginOffsetX);
  rei[2]->SetCenterZ(0.);
  rei[2]->SetCenterY(-0.25*m_PhantomScale);
  rei[2]->SetRotationAngle(108.);
  rei[2]->SetMultiplicativeConstant(-0.02);

  rei[3]->SetSemiPrincipalAxisX(0.31*m_PhantomScale);
  rei[3]->SetSemiPrincipalAxisZ(0.11*m_PhantomScale);
  rei[3]->SetSemiPrincipalAxisY(0.22*m_PhantomScale);
  rei[3]->SetCenterX(0.22*m_PhantomScale + m_PhantomOriginOffsetX);
  rei[3]->SetCenterZ(0.);
  rei[3]->SetCenterY(-0.25*m_PhantomScale);
  rei[3]->SetRotationAngle(72.);
  rei[3]->SetMultiplicativeConstant(-0.02);

  rei[4]->SetSemiPrincipalAxisX(0.21*m_PhantomScale);
  rei[4]->SetSemiPrincipalAxisZ(0.25*m_PhantomScale);
  rei[4]->SetSemiPrincipalAxisY(0.50*m_PhantomScale);
  rei[4]->SetCenterX(m_PhantomOriginOffsetX);
  rei[4]->SetCenterZ(0.35*m_PhantomScale);
  rei[4]->SetCenterY(-0.25*m_PhantomScale);
  ...
  rei[5]->SetCenterZ(0.10*m_PhantomScale);
  rei[5]->SetCenterY(-0.25*m_PhantomScale);
  rei[5]->SetRotationAngle(0.);
  rei[5]->SetMultiplicativeConstant(0.02);

  rei[6]->SetSemiPrincipalAxisX(0.046*m_PhantomScale);
  rei[6]->SetSemiPrincipalAxisZ(0.023*m_PhantomScale);
  rei[6]->SetSemiPrincipalAxisY(0.020*m_PhantomScale);
  rei[6]->SetCenterX(-0.08*m_PhantomScale + m_PhantomOriginOffsetX);
  rei[6]->SetCenterZ(-0.650*m_PhantomScale);
  rei[6]->SetCenterY(-0.250*m_PhantomScale);
  rei[6]->SetRotationAngle(0.);
  rei[6]->SetMultiplicativeConstant(0.01);

  rei[7]->SetSemiPrincipalAxisX(0.046*m_PhantomScale);
  rei[7]->SetSemiPrincipalAxisZ(0.023*m_PhantomScale);
  rei[7]->SetSemiPrincipalAxisY(0.020*m_PhantomScale);
  rei[7]->SetCenterX(0.06*m_PhantomScale + m_PhantomOriginOffsetX);
  rei[7]->SetCenterZ(-0.65*m_PhantomScale);
  rei[7]->SetCenterY(-0.25*m_PhantomScale);
  rei[7]->SetRotationAngle(90.);
  rei[7]->SetMultiplicativeConstant(0.01);

  rei[8]->SetSemiPrincipalAxisX(0.056*m_PhantomScale);
  rei[8]->SetSemiPrincipalAxisZ(0.040*m_PhantomScale);
  rei[8]->SetSemiPrincipalAxisY(0.010*m_PhantomScale);
  rei[8]->SetCenterX(0.060*m_PhantomScale + m_PhantomOriginOffsetX);
  rei[8]->SetCenterZ(-0.105*m_PhantomScale);
  rei[8]->SetCenterY(0.625*m_PhantomScale);
  rei[8]->SetRotationAngle(90.);
  rei[8]->SetMultiplicativeConstant(0.02);

  rei[9]->SetSemiPrincipalAxisX(0.056*m_PhantomScale);
  rei[9]->SetSemiPrincipalAxisZ(0.056*m_PhantomScale);
  rei[9]->SetSemiPrincipalAxisY(0.100*m_PhantomScale);
  rei[9]->SetCenterX(m_PhantomOriginOffsetX);
  rei[9]->SetCenterZ(0.100*m_PhantomScale);
  rei[9]->SetCenterY(0.625*m_PhantomScale);
