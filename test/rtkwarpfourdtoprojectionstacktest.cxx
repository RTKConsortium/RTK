...
main(int, char **)
{
  ...
  auto spacing = itk::MakeVector(16.0, 8.0, 16.0);
#else
  auto size = itk::MakeSize(64, 64, 64);
  auto spacing = itk::MakeVector(2.0, 1.0, 2.0);
#endif
  ...
  auto fourDSpacing = itk::MakeVector(16.0, 8.0, 16.0, 1.0);
#else
  auto fourDSize = itk::MakeSize(64, 64, 64, 8);
  auto fourDSpacing = itk::MakeVector(2.0, 1.0, 2.0, 1.0);
#endif
  ...
  origin = itk::MakePoint(-254.0, -254.0, -254.0);
#if FAST_TESTS_NO_CHECKS
  size = itk::MakeSize(32, 32, NumberOfProjectionImages);
  spacing = itk::MakeVector(32.0, 32.0, 32.0);
#else
  size = itk::MakeSize(128, 128, NumberOfProjectionImages);
  spacing = itk::MakeVector(4.0, 4.0, 1.0);
#endif
  ...
  auto startMotion = itk::MakeIndex(0, 0, 0, 0);
