...
main(int, char **)
{
  ...
  imgRef->SetSpacing(itk::MakeVector(4., 4.));
  imgRef->SetSize(itk::MakeSize(2, 2));
  ...
  imgRef->SetSpacing(itk::MakeVector(8., 4.));
  imgRef->SetSize(itk::MakeSize(1, 2));
  imgRef->UpdateLargestPossibleRegion();
  ...
  imgRef->SetSpacing(itk::MakeVector(4., 8.));
  imgRef->SetSize(itk::MakeSize(2, 1));
  imgRef->UpdateLargestPossibleRegion();
