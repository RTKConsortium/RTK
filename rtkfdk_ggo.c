/*
  ...
  /home/srit/src/gengetopt/gengetopt-2.22.4-lin64/src/gengetopt --output-dir=/home/srit/src/rtk/rtk --arg-struct-name=args_info_rtkfdk --func-name=cmdline_parser_rtkfdk --file-name=rtkfdk_ggo --unamed-opts --conf-parser --include-getopt 
...
const char *args_info_rtkfdk_help[] = {
  ...
  "  -d, --divisions=INT    Number of stream divisions to cope with large CTs  \n                           (default=`1')",
  "\nRamp filter:",
...
void init_args_info(struct args_info_rtkfdk *args_info)
{
  ...
  args_info->verbose_help = args_info_rtkfdk_help[2] ;
  args_info->config_help = args_info_rtkfdk_help[3] ;
  args_info->geometry_help = args_info_rtkfdk_help[4] ;
  ...
  args_info->divisions_help = args_info_rtkfdk_help[10] ;
  args_info->pad_help = args_info_rtkfdk_help[12] ;
  args_info->hann_help = args_info_rtkfdk_help[13] ;
  args_info->origin_help = args_info_rtkfdk_help[15] ;
  args_info->origin_min = 0;
  args_info->origin_max = 0;
  args_info->dimension_help = args_info_rtkfdk_help[16] ;
  args_info->dimension_min = 0;
  args_info->dimension_max = 0;
  args_info->spacing_help = args_info_rtkfdk_help[17] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "Vvg:p:r:o:h:ld:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'l':	/* Load only one projection per thread in memory.  */
          ...
          break;
        case 'd':	/* Number of stream divisions to cope with large CTs.  */
