/*
  ...
  /usr/bin/gengetopt --output-dir=/home/srit/src/rtk/RTK --arg-struct-name=args_info_rtkprojections --func-name=cmdline_parser_rtkprojections --file-name=rtkprojections_ggo --unamed-opts --conf-parser --include-getopt 
