/*
  ...
  /home/srit/src/gengetopt/gengetopt-2.22.4-lin64/src/gengetopt --output-dir=/home/srit/src/rtk/RTK --arg-struct-name=args_info_rtkprojections --func-name=cmdline_parser_rtkprojections --file-name=rtkprojections_ggo --unamed-opts --conf-parser --include-getopt 
...
const char *args_info_rtkprojections_purpose = "";

const char *args_info_rtkprojections_usage = "Usage: rtk [OPTIONS]... [FILES]...";

const char *args_info_rtkprojections_description = "";

const char *args_info_rtkprojections_help[] = {
...
typedef enum {ARG_NO
  , ARG_STRING
} cmdline_parser_rtkprojections_arg_type;

static
void clear_given (struct args_info_rtkprojections *args_info);
static
void clear_args (struct args_info_rtkprojections *args_info);

static int
cmdline_parser_rtkprojections_internal (int argc, char **argv, struct args_info_rtkprojections *args_info,
                        struct cmdline_parser_rtkprojections_params *params, const char *additional_error);

static int
cmdline_parser_rtkprojections_required2 (struct args_info_rtkprojections *args_info, const char *prog_name, const char *additional_error);
struct line_list
{
  char * string_arg;
...
static
void init_args_info(struct args_info_rtkprojections *args_info)
{


  args_info->help_help = args_info_rtkprojections_help[0] ;
  args_info->version_help = args_info_rtkprojections_help[1] ;
  args_info->config_help = args_info_rtkprojections_help[2] ;
  args_info->path_help = args_info_rtkprojections_help[3] ;
  args_info->regexp_help = args_info_rtkprojections_help[4] ;
  args_info->output_help = args_info_rtkprojections_help[5] ;
  
}

void
cmdline_parser_rtkprojections_print_version (void)
{
  printf ("%s %s\n",
     (strlen(CMDLINE_PARSER_RTKPROJECTIONS_PACKAGE_NAME) ? CMDLINE_PARSER_RTKPROJECTIONS_PACKAGE_NAME : CMDLINE_PARSER_RTKPROJECTIONS_PACKAGE),
     CMDLINE_PARSER_RTKPROJECTIONS_VERSION);
}

static void print_help_common(void) {
  cmdline_parser_rtkprojections_print_version ();

  if (strlen(args_info_rtkprojections_purpose) > 0)
    printf("\n%s\n", args_info_rtkprojections_purpose);

  if (strlen(args_info_rtkprojections_usage) > 0)
    printf("\n%s\n", args_info_rtkprojections_usage);

  printf("\n");

  if (strlen(args_info_rtkprojections_description) > 0)
    printf("%s\n\n", args_info_rtkprojections_description);
}

void
cmdline_parser_rtkprojections_print_help (void)
{
  int i = 0;
  print_help_common();
  while (args_info_rtkprojections_help[i])
    printf("%s\n", args_info_rtkprojections_help[i++]);
}

void
cmdline_parser_rtkprojections_init (struct args_info_rtkprojections *args_info)
{
...
void
cmdline_parser_rtkprojections_params_init(struct cmdline_parser_rtkprojections_params *params)
{
  if (params)
    { 
      params->override = 0;
...
struct cmdline_parser_rtkprojections_params *
cmdline_parser_rtkprojections_params_create(void)
{
  struct cmdline_parser_rtkprojections_params *params = 
    (struct cmdline_parser_rtkprojections_params *)malloc(sizeof(struct cmdline_parser_rtkprojections_params));
  cmdline_parser_rtkprojections_params_init(params);  
  return params;
}
...
static void
cmdline_parser_rtkprojections_release (struct args_info_rtkprojections *args_info)
{
  unsigned int i;
...
int
cmdline_parser_rtkprojections_dump(FILE *outfile, struct args_info_rtkprojections *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", CMDLINE_PARSER_RTKPROJECTIONS_PACKAGE);
      return EXIT_FAILURE;
    }
...
int
cmdline_parser_rtkprojections_file_save(const char *filename, struct args_info_rtkprojections *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", CMDLINE_PARSER_RTKPROJECTIONS_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = cmdline_parser_rtkprojections_dump(outfile, args_info);
  fclose (outfile);
...
void
cmdline_parser_rtkprojections_free (struct args_info_rtkprojections *args_info)
{
  cmdline_parser_rtkprojections_release (args_info);
}
...
int
cmdline_parser_rtkprojections (int argc, char **argv, struct args_info_rtkprojections *args_info)
{
  return cmdline_parser_rtkprojections2 (argc, argv, args_info, 0, 1, 1);
}

int
cmdline_parser_rtkprojections_ext (int argc, char **argv, struct args_info_rtkprojections *args_info,
                   struct cmdline_parser_rtkprojections_params *params)
{
  int result;
  result = cmdline_parser_rtkprojections_internal (argc, argv, args_info, params, 0);

  if (result == EXIT_FAILURE)
    {
      cmdline_parser_rtkprojections_free (args_info);
      exit (EXIT_FAILURE);
    }
...
int
cmdline_parser_rtkprojections2 (int argc, char **argv, struct args_info_rtkprojections *args_info, int override, int initialize, int check_required)
{
  int result;
  struct cmdline_parser_rtkprojections_params params;
...
int
cmdline_parser_rtkprojections_required (struct args_info_rtkprojections *args_info, const char *prog_name)
{
  int result = EXIT_SUCCESS;

  if (cmdline_parser_rtkprojections_required2(args_info, prog_name, 0) > 0)
    result = EXIT_FAILURE;
 ...
 * @param check_ambiguity @see cmdline_parser_rtkprojections_params.check_ambiguity
 * @param override @see cmdline_parser_rtkprojections_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               cmdline_parser_rtkprojections_arg_type arg_type,
...
int
cmdline_parser_rtkprojections_internal (
  int argc, char **argv, struct args_info_rtkprojections *args_info,
                        struct cmdline_parser_rtkprojections_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error = 0;
  struct args_info_rtkprojections local_args_info;
  ...
  if (initialize)
    cmdline_parser_rtkprojections_init (args_info);

  cmdline_parser_rtkprojections_init (&local_args_info);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          cmdline_parser_rtkprojections_print_help ();
          cmdline_parser_rtkprojections_free (&local_args_info);
          exit (EXIT_SUCCESS);
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", CMDLINE_PARSER_RTKPROJECTIONS_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  if (check_required)
    {
      error += cmdline_parser_rtkprojections_required2 (args_info, argv[0], additional_error);
    }

  cmdline_parser_rtkprojections_release (&local_args_info);
...
static int
_cmdline_parser_rtkprojections_configfile (const char *filename, int *my_argc)
{
  FILE* file;
  ...
  while ((fgets(linebuf, CONFIG_FILE_LINE_SIZE, file)) != 0)
      ...
      if (len > (CONFIG_FILE_LINE_BUFFER_SIZE-1))
        {
          fprintf (stderr, "%s:%s:%d: Line too long in configuration file\n",
                   CMDLINE_PARSER_RTKPROJECTIONS_PACKAGE, filename, line_num);
          result = EXIT_FAILURE;
          break;
        }
    ...
    noarg:
      if (!strcmp(fopt,"include")) {
        if (farg && *farg) {
          result = _cmdline_parser_rtkprojections_configfile(farg, my_argc);
        } else {
...
int
cmdline_parser_rtkprojections_configfile (
  const char *filename,
                           struct args_info_rtkprojections *args_info,
                           int override, int initialize, int check_required)
{
  ...
  return cmdline_parser_rtkprojections_config_file (filename, args_info, &params);
}

int
cmdline_parser_rtkprojections_config_file (const char *filename,
                           struct args_info_rtkprojections *args_info,
                           struct cmdline_parser_rtkprojections_params *params)
{
  int i, result;
  ...
  cmd_line_list_tmp->next = cmd_line_list;
  cmd_line_list = cmd_line_list_tmp;
  cmd_line_list->string_arg = gengetopt_strdup (CMDLINE_PARSER_RTKPROJECTIONS_PACKAGE);

  result = _cmdline_parser_rtkprojections_configfile(filename, &my_argc);
  ...
  if (result != EXIT_FAILURE) {
    ...
    result =
      cmdline_parser_rtkprojections_internal (my_argc, my_argv_arg, args_info,
                              params,
                              additional_error);
